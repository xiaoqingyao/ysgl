<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YstzAuditList.aspx.cs" Inherits="BillYstz_YstzAuditList" %>
                    ...
                    <ItemTemplate>
                        <div data-role="collapsible" data-collapsed="false" data-theme="b" class="c-main">
                            <h1>
                                <div class="title">
                                    <div class="title-l">
                                        <asp:Literal ID="Literal1" runat="server" Text='<%#Eval("showdept") %>'></asp:Literal>预算调整申请
                                    </div>
                                    <div class="title-r">
