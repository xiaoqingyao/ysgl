<%@ Page Language="C#" AutoEventWireup="true" CodeFile="travelApplyList.aspx.cs" Inherits="BillTravelApply_travelApplyList" %>
    ...
    <script>
        ...
        function View(flowId, code, dept) {
            ...
            $.post("../workflow/GetBillType.ashx", { "billcode": code }, function (data, status) {
                if (status == "success") {
                    $("#open").attr("href", "travelApplyView.aspx?billCode=" + code + "&type=View");
                    $("#open").click();
                    //获取单据审批流详细信息
        ...
        function Edit(code) {
            window.location.href = "travelApplyEdit.aspx?billCode=" + code + "&type=edit";
        }
    ...
    <form id="form1" runat="server" data-role="page" data-theme="b" method="post" data-ajax="false">
        <div>
            <div data-role="header">
                ...
                <h1>我的出差申请单</h1>
                <a href="travelApplyEdit.aspx?type=add" data-role="button" class="ui-btn-right" data-icon="plus"
