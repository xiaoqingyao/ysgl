<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ybbxView_tf.aspx.cs" Inherits="bxd_ybbxView_tf" %>
        ...
        <div>
            ...
            <div data-role="content">
                <table style="color: Black; font-family: 微软雅黑;">
                    ...
                    <tr>
                        <td class='tdborder'>金额：
                        </td>
                        <td class='tdborder'>￥<asp:Label ID="lbBillje" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class='tdborder'>是否归口：
                        </td>
                        <td class='tdborder'>
                            <asp:Label ID="lbIsgk" runat="server"></asp:Label>
                        </td>
                    </tr>

                    <tr id="tdgk" runat="server">
                        <td class='tdborder'>归口部门
                        </td>
                        <td class='tdborder' colspan="3">
                            <asp:Label ID="lbGkdept" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class='tdborder'>单据类型：
                        </td>
                        <td class='tdborder'>
                            <asp:Label ID="lbBillType" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 90px;" class='tdborder'>备注：
                        </td>
                        <td class='tdborder'>
                            <asp:Label ID="lbBxzy" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>所在分校
                        ...
                        <td>
                            <asp:Label ID="lblszfx" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>学员姓名：
                        ...
                        <td>
                            <asp:Label ID="lblxyxm" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>所在年级
                        ...
                        <td>
                            <asp:Label ID="lblsznj" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>协议编号：
                        ...
                        <td>
                            <asp:Label ID="lblxybh" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>签单时间：
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="lblhm" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>建行账号：
                        ...
                        <td>
                            <asp:Label ID="lbljhzh" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>协议辅导费用：
                        ...
                        <td>
                            <asp:Label ID="lblxyfdfy" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>已消费课时：
                        ...
                        <td>
                            <asp:Label ID="lblyxfks" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>对应课时单价：
                        ...
                        <td>
                            <asp:Label ID="lbldyksdj" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>已消费费用：
                        ...
                        <td>
                            <asp:Label ID="lblyxffy" runat="server"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>应扣其他费用：
                        ...
                        <td>
                            <asp:Label ID="lblykqtfy" runat="server"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <%-- <tr>
                        ...
                        <td>
                            <asp:Label ID="lbldjs" runat="server"></asp:Label>
                        </td>
                          </tr>--%>
                    <tr>
                        <td class='tdborder'>退费原因：
                        </td>
                        <td class='tdborder'>
                            <asp:Label ID="lbBxsm" runat="server"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>附件：</td>
                        <td>
                            <asp:Literal ID="lalFuJian" runat="server"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
