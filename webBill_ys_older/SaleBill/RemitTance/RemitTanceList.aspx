<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RemitTanceList.aspx.cs" Inherits="SaleBill_RemitTance_RemitTanceList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>车款上缴明细表</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
        ...
        $(function() {
            ...
            //修改
             $("#btn_edit").click(function() {
                ...
                openDetail("RemitTanceDetails.aspx?Ctrl=Edit&Code="+ billcode);
            });
            //删除
              $("#btn_delete").click(function() {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                $.post("../../webBill/MyAjax/DeleteBill.ashx", { "billCode": billcode, "type": "cksj" }, function(data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
          ...
          $("#btn_print").click(function() {
                ...
                openprint("RemitTancePrint.aspx?Ctrl=print&Code=" + billcode+"&je="+hkje);
            });
               //撤销单据提交
            $("#btn_replace").click(function() {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../../webBill/MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "cksj", "billtype": "cksj" }, function(data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("撤销成功！");
            ...
            $("#btn_summit").click(function() {
                ...
                if (zt != "未提交") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../../webBill/MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "cksj", "billtype": "cksj" }, function(data, status) {
                        if (data == "-1" || data == "-2") {
                            alert("提交失败！");
                        } else if (data == "-3") {
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 27px">
                ...
                <input type="button" value="增 加" runat="server" id="Button1" class="baseButton" onclick="openDetail('RemitTanceDetails.aspx?Ctrl=Add&par=' + Math.random());" />
            ...
            <td align="left">
                <div style="float: left">
                    <table class="baseTable" style="text-align: left;">
                        ...
                        <td>
                            <asp:TextBox ID="txtRemittanceType" runat="server" Width="120px"></asp:TextBox>
                        </td>--%>
                ...
                <div id="main" style="overflow-y: scroll; margin-top: -1px; width: 1100px; height: 390px;">
                    <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                        ...
                        <Columns>
                            ...
                            <%--                        <asp:BoundColumn DataField="OrderCode" HeaderText="订单号">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Left" Wrap="False" CssClass="myGridHeader" />
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <%--<asp:BoundColumn DataField="RemittanceNumber" HeaderText="汇款辆数">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <%-- <asp:BoundColumn DataField="RemittanceType" HeaderText="回款形式">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <%-- <asp:BoundColumn DataField="RemittanceUse" HeaderText="回款用途">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" Wrap="False" CssClass="myGridItem" HorizontalAlign="Left" />
