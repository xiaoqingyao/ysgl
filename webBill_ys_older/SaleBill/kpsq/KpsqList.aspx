<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KpsqList.aspx.cs" Inherits="SaleBill_kpsq_KpsqList" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        $(function() {
            ...
            $("#btn_summit").click(function() {
                ...
                if (zt != "未提交") {
                    ...
                    $.post("../../webBill/MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "kpsq", "billtype": "kpsq" }, function(data, status) {
                        if (data == "-1" || data == "-2") {
                            alert("提交失败！");
                        } else if (data == "-3") {
            ...
            $("#btn_replace").click(function() {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../../webBill/MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "kpsq", "billtype": "kpsq" }, function(data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("撤销成功！");
        ...
        function openDetail(openUrl) {
            var returnValue = window.showModalDialog(openUrl, 'newwindow', 'center:yes;dialogHeight:600px;dialogWidth:1050px;status:no;scroll:yes');
            if (returnValue == "1") {
                location.replace(location.href);
            }
        }
        function Edit() {
            ...
            if (checkrow.val() == undefined) {
                ...
                if (lx == "未提交") {
                    ...
                    openDetail('KpsqDetails.aspx?type=Edit&&bh=' + bh);
                } else {
                alert("该行已经提交，不允许修改！");
                    return false;
                }
        ...
        function Look() {
            ...
            if (checkrow.val() == undefined) {
                ...
                var bh = checkrow.find("td")[0].innerHTML;
                openDetail('KpsqDetails.aspx?type=look&&bh=' + bh);
            }
        }
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td>
                    <div class="baseDiv" style="margin-bottom: 3px; margin-top: 3px">
                        ...
                        <input type="button" value="增 加" runat="server" id="Button1" class="baseButton" onclick="openDetail('KpsqDetails.aspx?type=Add')" />
            ...
            <tr>
                <td>
                    ...
                    <div class="baseDiv" id="main" style="overflow-y: scroll; margin-top: -1px; width: 1100px; height: 380px;">
                        <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="billdeptshow" HeaderText="申请单位">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                ...
                                <asp:BoundColumn HeaderText="车架号" ItemStyle-HorizontalAlign="Left">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="true" CssClass="myGridItem" HorizontalAlign="Center" />
