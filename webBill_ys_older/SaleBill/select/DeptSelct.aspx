<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeptSelct.aspx.cs" Inherits="SaleBill_select_DeptSelct" %>
        ...
        <tr>
            <td>
                <asp:TreeView ID="TreeView1" runat="server" ShowLines="True" ExpandDepth="2">
                        <Nodes>
                            <asp:TreeNode ImageUrl="../../webBill/Resources/Images/treeView/treeHome.gif" SelectAction="None" Text="部门选择" Value=""></asp:TreeNode>
                        </Nodes>
                    </asp:TreeView>
            </td>
        </tr>
