<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MainNew2.aspx.cs" Inherits="webBill_main_MainNew2"  EnableViewState="false"%>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        /*原来的#EBF2F5*/#accordion-left, #accordion-right
        {
            width: 500px;
            display: block;
            margin: 10px;
    ...
    <script type="text/javascript" language="javascript" charset="gb2312">
        $(function() {
           ...
           $tabs = $("#right").tabs({
                ...
                add: function(event, ui) {
                    ...
                    $(ui.panel).append("<iframe src='" + link + "' width='100%' height='95%' frameborder='0'></iframe>");
                },
        ...
        function showProductOrgBom(pnid) {
         ...
         function ViewMsg(id) {
            openDetail1("../message/message.aspx?id="+id);
        }
    
    $(function(){
     $(".panel .panel-header").each(function()
     {
       $(this).find("img").each(function(index,obj){
         ...
         if(index==1)
         {
             $(this).click(function(){
                  ...
                  if($(this).hasClass("panel-tool-expand"))
                   $(this).parent().parent().next("div").fadeOut("slow");
                  else
                  $(this).parent().parent().next("div").fadeIn("slow");
         ...
         {
            $(this).click(function(){
            //alert($(this).parentsUntil("div[class='content']").size());
            // $(this).parentsUntil("div[class='content']").eq(0).parent().hide();
...
<body>
    ...
    <div id="right" style="width: 83%">
        ...
        <div id="tabs-1">
            <div id="accordion-left">
                <div class="panel" style="width: 500px;">
                    <div class="panel-header" style="vertical-align: middle">
                        
                            <img src="../Resources/Css/images/view.png" /><span>新闻通知</span> <span style="float: right;
                                margin-right: 0px; line-height: 25px">
                                <img class="panel-tool-collapse" /><img class="panel-tool-close" /></span></div>
                    
                    <div id="dlgMsg" runat="server" class="content" style="word-warp: break-word; word-break: break-all;">
                        <table id="tabMsg"  width="100%" style="line-height:20px;">
                         <%--  <tr>
                                <th>
                                    标题
                                </th>
                                ...
                                <ItemTemplate>
                                    <tr >
                                        <td style="border-bottom:1px dashed gray; ">
                                            <%#Eval("title") %>
                                            <asp:Literal ID="ltlMsgId" Text='<%#Eval("id") %>' runat="server"></asp:Literal>
                                        </td>
                                        <td style="border-bottom:1px dashed gray; ">
                                            <%#Eval("writer") %>
                                        </td>
                                        ...
                                        <td style="border-bottom:1px dashed gray; ">
                                            <asp:Label ID="lblMsgOperate" runat="server" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                ...
                <div class="panel" style="width: 500px;">
                    <div class="panel-header" style="vertical-align: middle">                      
                            <img src="../Resources/Css/images/undo.png" /><span>我的单据</span> <span style="float: right;
                                margin-right: 0px; line-height: 25px">
                                <img class="panel-tool-collapse" /><img class="panel-tool-close" /></span>
                    </div>
                    <div runat="server" class="content" style="word-warp: break-word; word-break: break-all;">
                        <asp:GridView ID="myGrid" runat="server" Style="table-layout: fixed" Width="100%"
                            CssClass="myGrid" AutoGenerateColumns="False" BorderStyle="None" OnRowDataBound="myGrid_ItemDataBound">
                            <Columns>
                        ...
                        <div style="text-align: right" runat="server" id="podiv">
                            <a href="#" onclick="openDetail1('PoMoreList.aspx');" style="color: Blue; font-size: small;
                                margin-left: 5px; padding-right: 15px;">更多>></a></div>
                    </div>
                </div>
                
                <div class="panel" style="width: 500px;">
                    <div class="panel-header" style="vertical-align: middle">                     
                            <img src="../Resources/Css/images/undo.png" /><span>代办事项</span> <span style="float: right;
                                margin-right: 0px; line-height: 25px">
                                <img class="panel-tool-collapse" /><img class="panel-tool-close" /></span>
                    </div>
                    <div  runat="server" class="content" style="word-warp: break-word; word-break: break-all;">
            ...
            <div class="panel" style="width: 480px;height:360px;">
                    <div class="panel-header" style="vertical-align: middle">                        
                            <img src="../images/datebox_arrow.png" /><span>每日记事</span> <span style="float: right;
                                margin-right: 0px; line-height: 25px">
                                <img class="panel-tool-collapse" /><img class="panel-tool-close" /></span>
                    </div>
                    <div id="Div1" runat="server" class="content" style="word-warp: break-word; word-break: break-all;">
                            ...
                            var F = (function() {
                                ...
                                function Y(e, c) {
                                    ...
                                    $.post("../MyAjax/GetNote.ashx", { "tempDate": tempDate }, function(data, status) {
                                       ...
                                       // c="<div style='z-index:999999999'>"+c+"</div>";
     ...
     <div style="float: left; height: 100%; width: 10%; border: 1px solid #c3d9ff; padding: 1px;
        display: none" id="help">
        ...
        <div style="float: left; word-wrap: break-word; padding: 0px; width: 90%; border: 1px solid bule">
            <div style="height: 21px; background-color: #70A8D2; line-height: 21px; text-align: center;
                font-family: @微软雅黑">
                帮 助 (H)</div>
