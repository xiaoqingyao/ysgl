<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jkth.aspx.cs" Inherits="webBill_cwgl_jkth" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td>
                <asp:Button ID="btn_edit" runat="server" Text="借款退还" CssClass="baseButton" OnClientClick="return confirm('退还后不能恢复，是否继续？');"
                ...
                <asp:Button ID="Button2" runat="server" CssClass="baseButton" OnClick="Button2_Click"
                    Text="详细信息" />申请日期从：<asp:TextBox ID="txb_sqrqbegin" runat="server" Width="90px"></asp:TextBox>至<asp:TextBox
                        ID="txb_sqrqend" runat="server" Width="90px"></asp:TextBox>申请类型：<asp:DropDownList
            ...
            <td>
                <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                    ...
                    <Columns>
                        ...
                        <asp:BoundColumn DataField="xtje" HeaderText="需退金额" DataFormatString="{0:F2}">
                            <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                            <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                Font-Underline="False" Wrap="False" CssClass="myGridItemRight" />
