<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PingZhengDetailForU810.aspx.cs"
    Inherits="webBill_cwgl_PingZhengDetailForU810" %>
    ...
    <div class="baseDiv" style="margin-left: 5px; margin-top: 5px; width: 99%;">
        <table class="baseTable" style="margin-left: 0px; background-color: #EBF2F5;">
            <tr>
                ...
                <td>年度：</td>
                <td><asp:DropDownList ID="ddlNd" runat="server" AutoPostBack="true" OnSelectedIndexChanged="OnNd_SelectedIndexChanged">
                    </asp:DropDownList></td><td colspan="4"></td>
            </tr>
            <tr>
                <td style="text-align: right">
                    制单日期：
            ...
            <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="false" CssClass="myGrid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="明细科目" ControlStyle-Width="200">
                        <ItemTemplate>
                            <asp:TextBox ID="txtMingXiKemu" runat="server" Text="" Width="90%"></asp:TextBox><%--onkeydown="javascript:return false;"--%>
                    ...
                    <asp:TemplateField HeaderText="辅助核算" ItemStyle-Width="200" FooterStyle-CssClass="myGridItem"
                        HeaderStyle-CssClass="myGridHeader" ItemStyle-CssClass="myGridItemCenter">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlxianjinliu" runat="server" Width="98%">
                            </asp:DropDownList>
                            <br />
                            <asp:DropDownList ID="ddlbigclass" runat="server" Width="48%" OnSelectedIndexChanged="bigclasschanged"
                                AutoPostBack="true">
                            </asp:DropDownList>
                            <asp:DropDownList ID="ddlsmallclass" runat="server" Width="48%">
                            </asp:DropDownList>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField DataField="billDept" HeaderText="使用部门" FooterStyle-CssClass="myGridItem"
                        HeaderStyle-CssClass="myGridHeader" ItemStyle-CssClass="myGridItemCenter" />
                    ...
                    <asp:BoundField DataField="fykmName" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%-- 13是否现金科目--%>
                    <asp:BoundField DataField="bcash" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--14是否部门核算--%>
                    <asp:BoundField DataField="bdept" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--15是否个人往来核算 --%>
                    <asp:BoundField DataField="bperson" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--16是否客户往来核算--%>
                    <asp:BoundField DataField="bcus" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--17是否供应商往来核算--%>
                    <asp:BoundField DataField="bsup" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--18是否项目核算--%>
                    <asp:BoundField DataField="bitem" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--19财务科目对应项目大类编码--%>
                    <asp:BoundField DataField="cass_item" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--20大类 临时存储--%>
                    <asp:BoundField DataField="bigclasscode" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--21xiao类 临时存储--%>
                    <asp:BoundField DataField="smallclasscode" HeaderStyle-CssClass="hiddenbill" ItemStyle-CssClass="hiddenbill"
                        FooterStyle-CssClass="hiddenbill" />
                    <%--22 现金流量 临时存储--%>
