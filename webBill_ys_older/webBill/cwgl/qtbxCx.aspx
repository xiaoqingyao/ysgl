<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qtbxCx.aspx.cs" Inherits="webBill_cwgl_qtbxCx" %>

<%@ Register Assembly="UcfarPager" Namespace="UcfarPager" TagPrefix="pager" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>其他报销给付撤销</title>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 27px">
                <asp:Button ID="Button1" runat="server" Text="报销给付" CssClass="baseButton" OnClientClick="return confirm('给付后不能恢复，是否继续？');"
        ...
        <tr>
            <td>
                ...
                <div id="divgrid" style="overflow-y: scroll; margin-top: -1px;">
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="billDate" HeaderText="报销申请日期" DataFormatString="{0:D}">
                                <HeaderStyle Font-Bold="True" Width="150" Font-Italic="False" Font-Overline="False"
                            ...
                            <asp:BoundColumn DataField="gfr" HeaderText="给付人">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="true" CssClass="myGridItem" />
                            ...
                            <asp:TemplateColumn HeaderText="撤销原因">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemTemplate>
                                    <asp:TextBox ID="TextBox2" runat="server" Width="293px" Wrap="true"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateColumn>
