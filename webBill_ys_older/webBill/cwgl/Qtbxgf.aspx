<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Qtbxgf.aspx.cs" Inherits="webBill_cwgl_Qtbxgf" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 27px">
                <asp:Button ID="Button1" runat="server" Text="报销给付" CssClass="baseButton" OnClientClick="return confirm('确认给付？')"
        ...
        <tr>
            <td>
                ...
                <div id="divgrid" style=" overflow-x:auto; margin-top: -1px; ">
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                       CssClass="myGrid" Style="table-layout: fixed"  AllowPaging="false">
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="billDate" HeaderText="报销申请日期" DataFormatString="{0:D}">
                                ...
                                <ItemStyle  Font-Italic="False" Width="150" Font-Overline="False"
