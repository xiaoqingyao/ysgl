<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jkgf.aspx.cs" Inherits="webBill_cwgl_jkgf" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
        <tr>
            <td>
                <asp:Button ID="btn_edit" runat="server" Text="借款给付" CssClass="baseButton" OnClientClick="return confirm('给付后不能恢复，是否继续？')"
