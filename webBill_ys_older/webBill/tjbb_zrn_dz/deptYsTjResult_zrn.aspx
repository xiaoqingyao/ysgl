<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deptYsTjResult_zrn.aspx.cs" Inherits="webBill_tjbb_zrn_dz_deptYsTjResult_zrn" %>
...
<head runat="server">
    ...
    <script language="javascript" type="Text/javascript">
        $(function () {
            gudingbiaotounew($("#myGrid"), $(window).height() - 180);
                ...
                <td align="left">
                    <div style="position: relative; word-warp: break-word; word-break: break-all">
                        <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="bmbh" HeaderText="部门/科目编号" ItemStyle-Width="100" HeaderStyle-Width="100">
                                ...
                                <asp:BoundColumn DataField="bmmc" HeaderText="部门/科目名称" ItemStyle-Width="100" HeaderStyle-Width="100">
                                    <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                        Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="true" />
                                    <ItemStyle CssClass="myGridItem" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="true" />
                                ...
                                <asp:BoundColumn DataField="dqjssyje" HeaderText="本期决算剩余金额" DataFormatString="{0:N2}"
            ...
            <tr>
                <td>
                    <div>
                        报表说明：
                        <ul>
                            <li>本年度预算：财年年度预算+项目年度预算</li>
                            <li>本期预算：查询条件的时间段内财年月份的预算额度合计</li>
                            <li>本期决算金额：查询条件的时间段内的决算金额合计，决算金额以新财年费用报销单为准</li>
                            <li>本年度预算剩余金额：本年度预算-本年度决算</li>
                            <li>本期决算剩余金额：本期预算-本期决算</li>
                        </ul>
                    </div>
                </td>
            </tr>
