...
public partial class webBill_tjbb_zrn_dz_fykmYsTjResult_zrn : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        string strsql = "exec [pro_bill_bxtj_yskm_dz_zrn] '" + nd + "','" + ksyf + "','" + jzyf + "', '" + dept + "','" + Request["ishz"] + "','" + strdydj + "','" + kssj + "','" + jzsj + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("deptYsTj_zrn.aspx?dydj=" + strdydj);
    }
