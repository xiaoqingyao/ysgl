...
public partial class webBill_DeskMessage_MessageList : System.Web.UI.Page
{
    ...
    private void PaginationPrepare()
    {
        ...
        int rows = deskMgr.GetMessageCount(userCode);
    ...
    private void GridBind()
    {
        ...
        GridView1.DataSource = deskMgr.GetMessageByMaker(userCode,pagerows[0], pagerows[1]);
        GridView1.DataBind();
    }

    protected void btn_insert_Click(object sender, EventArgs e)
    {
        Response.Redirect("NewsDetails.aspx?type=message&action=add");
    }
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("NewsDetails.aspx?type=message&action=edit&code=" + code);
    }
