<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deptList_ImportExcel.aspx.cs"
    Inherits="webBill_Dept_DeptImportExcel" %>
    ...
    <div class="baseDiv">
        ...
        <table class="myTable" width="100%">
            <tr>
                ...
                <td>
                    <a href="DeptImport.xls" class="baseButton" target="_blank" style="display: block; text-align:center;width:45px">导出</a>
                </td>
            </tr>
            <tr>
                <td class="style1">
