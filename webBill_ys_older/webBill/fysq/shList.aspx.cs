...
public partial class fysq_shList : System.Web.UI.Page
{
    ...
    protected void btn_edit_Click(object sender, EventArgs e)
    {
        ...
        {
            (new workFlowLibrary.workFlow()).checkBills("fysq", billCode, Session["userCode"].ToString().Trim(), System.DateTime.Now.ToString(), shyj, true);
            this.BindDataGrid();
        }
    }
    protected void btn_tj_Click(object sender, EventArgs e)
    {
        ...
        {
            (new workFlowLibrary.workFlow()).checkBills("fysq", billCode, Session["userCode"].ToString().Trim(), System.DateTime.Now.ToString(), shyj, false);
            this.BindDataGrid();
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "", "openLookShgc('../../workFlow/stepLook.aspx?billType=fysq&billCode=" + billCode + "');", true);
        }
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            ClientScript.RegisterStartupScript(this.GetType(), "", "openDetail('sqDetail.aspx?type=look&billCode=" + billGuid + "');", true);
