<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectLscg.aspx.cs" Inherits="webBill_fysq_selectLscg" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>选择报告申请单</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
    <base target="_self" />
...
<body>
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td>
                    &nbsp;<asp:Button ID="btn_edit" runat="server" Text="确定选择" CssClass="baseButton" OnClick="btn_edit_Click" />
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass="baseButton" OnClick="Button1_Click" Text="关闭" /></td>
            </tr>
            <tr>
                <td>
