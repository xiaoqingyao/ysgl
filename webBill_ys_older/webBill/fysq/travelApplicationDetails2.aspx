<%@ Page Language="C#" AutoEventWireup="true" CodeFile="travelApplicationDetails2.aspx.cs"
    Inherits="travelApplicationDetails2" %>
...
<body style="background-color: #EBF2F5;">
    <center>
        ...
        <table cellpadding="0" cellspacing="0" class="style1" width="90%" border="0">
            ...
            <tr>
                <td style="text-align: center; height: 26px;" colspan="6">
                    <strong><span style="font-size: 15pt">出差管理单</span></strong>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="2" style="width: 55%">
                    出差派遣部门：<asp:TextBox ID="lbesendDept" runat="server" Text=""></asp:TextBox>
                </td>
                <td style="text-align: right; width: 50px;">
                </td>
                <td colspan="2">
                    日期： <span style="display: none">
                        <asp:Label ID="lbeBillCode" runat="server" Text=""></asp:Label></span>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="myTable">
                        ...
                        <tr>
                            ...
                            <td colspan="5"  style="text-align: center">
                                <asp:TextBox ID="txtTravelAddress" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tableBg2" style="text-align: right" >
                            ...
                            <td colspan="5"  style="text-align: center">
                                <asp:TextBox ID="txtPlanDate" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tableBg2" style="text-align: right">
                            ...
                            <td colspan="5"  style="text-align: center">
                                <asp:TextBox ID="txtReasion" runat="server" Height="150px" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="tableBg2" style="text-align: right">
                        ...
                        <tr>
                            <td style="text-align: center">
                                <input type="text" id="jiaotongfei" runat="server" style="width: 90%" onblur="replaceNaN(this);"
                                    onkeyup="replaceNaN(this);" />
                            </td>
                            <td style="text-align: center">
                                <input type="text" id="zhusufei" runat="server" style="width: 90%" onblur="replaceNaN(this);"
                                    onkeyup="replaceNaN(this);" />
                            </td>
                            <td style="text-align: center">
                                <input type="text" id="yewuzhaodaifei" runat="server" style="width: 90%" onblur="replaceNaN(this);"
                                    onkeyup="replaceNaN(this);" />
                            </td>
                            <td style="text-align: center">
                                <input type="text" id="huiyifei" runat="server" style="width: 90%" onblur="replaceNaN(this);"
                                    onkeyup="replaceNaN(this);" />
                            </td>
                            <td style="text-align: center">
                                <input type="text" id="yinshuafei" runat="server" style="width: 90%" onblur="replaceNaN(this);"
                                    onkeyup="replaceNaN(this);" />
                            </td>
                            <td style="text-align: center">
                                <input type="text" id="qitafei" runat="server" style="width: 90%" onblur="replaceNaN(this);"
                                    onkeyup="replaceNaN(this);" />
                            </td>
                        </tr>
                        ...
                        <tr id="tr1" runat="server">
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="txtPQBMManagerMind" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr id="tr2" runat="server">
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="txtBMManagerMind" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr id="tr3" runat="server">
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="txtFGManagerMind" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr id="tr4" runat="server">
                            ...
                            <td colspan="5">
                                <asp:TextBox ID="txtGeneralManagerMind" runat="server" TextMode="MultiLine" Width="98%"></asp:TextBox>
                            </td>
                        </tr>
