<%@ Page Language="C#" AutoEventWireup="true" CodeFile="lscgList.aspx.cs" Inherits="webBill_fysq_lscgList" %>
    ...
    <script language="javascript" type="Text/javascript">
        $(function () {
            ...
            $("#btn_edit").click(function () {
                ...
                openDetail("lscgDetail.aspx?type=edit&cgbh=" + billcode);
            ...
            $("#btn_delete").click(function () {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                $.post("../MyAjax/DeleteBill.ashx", { "billCode": billcode, "type": "lscg" }, function (data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
            ...
            $("#btn_look").click(function () {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                openDetail("lscgDetail.aspx?type=look&cgbh=" + billcode);
            });
            $("#btn_print").click(function () {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                window.open("../printer/printerLscg.aspx?billCode=" + billcode);
            });
            ...
            $("#btn_replace").click(function () {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "lscg" }, function (data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("撤销成功！");
            ...
            $("#btn_summit").click(function () {
                ...
                if (zt != "未提交") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "lscg" }, function (data, status) {
                        if (data == "-1" || data == "-2") {
                            alert("提交失败！");
                        } else if (data == "-3") {
...
<body>
    <form id="form1" runat="server" onsubmit="initWindowHW();">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td style="height: 30px;">日期从：<asp:TextBox ID="txb_sqrqbegin" runat="server" Width="80px"></asp:TextBox>至<asp:TextBox
                    ...
                    <input type="button" value="增 加" runat="server" id="Button1" class="baseButton" onclick="openDetail('lscgDetail.aspx?type=add&par=' + Math.random());" />
                ...
                <td>
                    <div id="divgrid" style="position: relative; overflow-x: auto; word-warp: break-word; word-break: break-all">
                        <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                            ItemStyle-HorizontalAlign="Center" Width="1500" AutoGenerateColumns="False" OnItemDataBound="myGrid_ItemDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="sj" HeaderText="申请日期" DataFormatString="{0:D}" HeaderStyle-Width="120"
                                    ItemStyle-Width="120">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                    <ItemStyle Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                ...
                                <asp:BoundColumn DataField="yjfy" HeaderText="预计费用" DataFormatString="{0:F2}" HeaderStyle-Width="120"
                                    ItemStyle-Width="120">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                    <ItemStyle Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                ...
                                <asp:BoundColumn HeaderText="驳回理由" DataField="mind" HeaderStyle-Width="120" ItemStyle-Width="120">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                    <ItemStyle Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" CssClass="myGridItemRight" />
