<%@ Page Language="C#" AutoEventWireup="true" CodeFile="phUserRightList.aspx.cs" Inherits="webBill_xtsz_phUserRightList" %>
                ...
                <td>
                    ...
                    <div id="main" style="overflow-y: scroll; margin-top: -1px; width: 800px; height: 420px;">
                        <asp:GridView EmptyDataText="暂时没有数据" ID="GridView1" runat="server" AllowSorting="True"
                            AutoGenerateColumns="False" CellPadding="0" Font-Size="9pt" BackColor="White"  ShowFooter="false"
