<%@ Page Language="C#" AutoEventWireup="true" CodeFile="czqxList2.aspx.cs" Inherits="webBill_xtsz_czqxList2" %>
            ...
            <table>
                ...
                <tr>
                    <td>
                        ...
                        <div id="main" style="overflow-y: scroll; margin-top: -1px; width: 800px; height: 430px;">
                            <asp:GridView EmptyDataText="暂时没有数据" ID="GridView1" runat="server" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="menuid" HeaderText="菜单编号" ItemStyle-Width="90" HeaderStyle-Width="90" />
                                    ...
                                    <asp:BoundField DataField="isCheckFlg" HeaderText="菜单说明" ItemStyle-CssClass="hiddenbill"
