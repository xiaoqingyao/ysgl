<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jsczqxList.aspx.cs" Inherits="xtsz_czqxList" %>
                ...
                <td>
                    <table class="baseTable">
                        ...
                        <tr>
                            ...
                            <td rowspan="27" style="width: 7px">
                            </td>
                            <td rowspan="10" style="width: 97px">
                                预算管理</td>
                            <td style="width: 167px">
                        ...
                        <tr>
                            <td style="width: 167px">
                                &nbsp;</td>
                            <td rowspan="13" style="width: 97px">
                                查询统计</td>
                            <td style="width: 167px">
