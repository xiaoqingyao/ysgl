<%@ Page Language="C#" AutoEventWireup="true" CodeFile="printerYbbx.aspx.cs" Inherits="webBill_printer_printerYbbx" %>
...
<head id="Head1" runat="server">
    <title>一般费用报销单打印</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
