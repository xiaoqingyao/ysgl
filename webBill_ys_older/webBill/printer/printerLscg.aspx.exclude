<%@ Page Language="C#" AutoEventWireup="true" CodeFile="printerLscg.aspx.cs" Inherits="webBill_printer_printerLscg" %>
...
<head runat="server">
    <title>报告申请打印</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
