<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ysxmFrame.aspx.cs" Inherits="webBill_newTj_ysxmFrame" %>
        ...
        <table cellpadding="0" id="taball" cellspacing="0" class="style1" width="100%">
            ...
            <tr>
                <td style="text-align: center; height: 27px;">
                    <strong><span style="font-size: 12pt">项目预算及报销统计</span></strong></td>
            </tr>
            <tr>
