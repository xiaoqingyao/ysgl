        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="height: 27px">
                    &nbsp;
                    &nbsp;&nbsp;预算项目<input id="txtSjxm" runat="server" readonly="readonly" style="width: 250px"
                        type="text" />
                    <asp:Button ID="btn_selectXm" runat="server" CausesValidation="False" CssClass="baseButton"
                        Text="选择" />
                    <asp:Button ID="Button2" runat="server" Text="确认填报" CssClass="baseButton" OnClick="Button2_Click" />
