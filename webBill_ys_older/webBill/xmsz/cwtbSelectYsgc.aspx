<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cwtbSelectYsgc.aspx.cs" Inherits="webBill_ysgl_cwtbSelectYsgc" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="height: 27px">
                    &nbsp;
                    &nbsp;预算项目<input id="txtSjxm" runat="server" readonly="readonly" style="width: 250px" type="text" />
                                <asp:Button ID="btn_selectXm" runat="server" Text="选择" CssClass="baseButton" CausesValidation="False" />&nbsp;<asp:Button ID="Button2" runat="server" Text="确认填报" CssClass="baseButton" OnClick="Button2_Click" />
                    ...
                    <asp:Label ID="Label1" runat="server" Text="选择预算过程" ForeColor="Red"></asp:Label></td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    CellPadding="3" CssClass="myGrid" PageSize="17" >
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="yue" HeaderText="预算季度/月份" Visible="False">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" CssClass="myGridItem" />
