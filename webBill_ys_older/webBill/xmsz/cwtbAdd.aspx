<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cwtbAdd.aspx.cs" Inherits="webBill_ysgl_cwtbAdd" %>
...
<head runat="server">
    ...
    <script language="javascript" type="Text/javascript">
        ...
        function openUpLoad(obj)
        {
            ...
            {
                var fj=webBill_ysgl_cwtbAdd.getFj(billCode,yskm).value;
        ...
        function deleteFj(obj)
        {
            ...
            var fj=webBill_ysgl_cwtbAdd.deleteFj(billCode,yskm).value;
            if(fj==true)
            {
        ...
        function calLj(obj)
        {
            ...
            var list=webBill_ysgl_cwtbAdd.getCalResult(currentCode,arrIndex,arrCode,arrVal).value;
