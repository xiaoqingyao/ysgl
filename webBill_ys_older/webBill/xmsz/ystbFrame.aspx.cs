...
public partial class ysgl_ystbFrame : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                this.Label1.Text = server.GetCellValue("select deptname from bill_departments where deptcode='" + (new billCoding()).GetDeptLevel2_userCode(Session["userCode"].ToString().Trim()) + "'") + " 已填报预算项目";
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                Response.Redirect("ystbEdit.aspx?billCode=" + billCode );
            }
        }
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            {
                //string sql = "delete from bill_ysmxb where billCode='" + billCode + "' and yskm in (select yskmcode from bill_yskm where tblx='01')";
                string sql = "delete from bill_ysmxb where billCode='" + billCode + "'";
                string sql2 = "delete from bill_main where billcode='" + billCode + "'";
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            Response.Redirect("cwtbDetail.aspx?from=ystbFrame&billCode=" + billCode + "&deptCode=" + deptCode);
        }
    }
    protected void Button4_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                //    return;
                //}
                if (double.Parse(server.GetCellValue("select billJe from bill_main where billcode='" + billCode + "'")) != double.Parse(server.GetCellValue("select sum(ysje) from bill_ysmxb where billcode='" + billCode + "'")))
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "", "alert('预算明细与主单金额不一致，不能提交！');", true);
                    return;
                }
