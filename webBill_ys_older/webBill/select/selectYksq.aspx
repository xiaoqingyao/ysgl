<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectYksq.aspx.cs" Inherits="webBill_select_selectYksq" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="float: left; width: 76%">
            ...
            <div style="margin-top: 5px;">
                <span style="margin-left: 150px;">选择部门：<asp:Label runat="server" ForeColor="Red" ID="lbl_dept"></asp:Label></span>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="baseTable" ShowFooter="false">
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="制单日期" DataField="billdate" ItemStyle-Width="90" HeaderStyle-Width="90" DataFormatString="{0:D}" />
                        <asp:BoundField HeaderText="部门" DataField="deptname" ItemStyle-CssClass="hiddenbill" HeaderStyle-CssClass="hiddenbill" />
                        <asp:BoundField HeaderText="金额" DataField="billje" ItemStyle-Width="50" HeaderStyle-Width="50" />
                        <asp:BoundField HeaderText="摘要" DataField="zy" ItemStyle-Width="300" HeaderStyle-Width="300" />
                    </Columns>
                </asp:GridView>
            </div>
