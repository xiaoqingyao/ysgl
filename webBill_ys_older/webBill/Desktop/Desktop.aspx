...
table{border:0}
#cal{width:434px;border:1px solid #c3d9ff;font-size:12px;margin:4px 2px 0 2px}
...
<script language="javascript" type="text/javascript">
    function openMsg(objID)
    {
        window.showModalDialog('../message/message.aspx?id='+objID , 'newwindow', 'center:yes;dialogHeight:430px;dialogWidth:720px;status:no;scroll:yes');
    }
   function editBill(url)
    {
         var returnValue=window.showModalDialog(url, 'newwindow', 'center:yes;dialogHeight:320px;dialogWidth:550px;status:no;scroll:no');
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="text-align: left; height: 22px;" class="tableBg">
                    <span style="font-size: 12pt; color: #ff0000"><strong>&nbsp;2、日&nbsp; 历</strong></span></td>
            </tr>
            <tr>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    &nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;农历<span></span>年&nbsp;[&nbsp;<span></span>年&nbsp;]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                                                        class="baseButton" type="button" value="回到今天" title="点击后跳转回今天" style="padding: 0px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
...
//-->
            ...
            <tr>
                <td runat="server" class="tableBg" style="width: 670px; text-align: left" valign="middle">
            ...
            <tr>
                <td runat="server" class="tableBg" rowspan="1" style="width: 670px; text-align: left"
                    valign="top">
                    <strong><span style="font-size: 12pt; color: #ff0000">6、技术支持</span></strong>
                </td>
                <td runat="server" rowspan="1" style="width: 670px" valign="top">
                </td>
            </tr>
            <tr>
                <td runat="server" rowspan="1" style="width: 670px; text-align: left" valign="top">
                    <table class="myGrid" cellpadding="0" cellspacing="0" border="0" style="width: 100%">
                        <tr class="myGridItem">
