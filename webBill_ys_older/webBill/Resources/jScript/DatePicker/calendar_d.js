...
/********************************************************
  名称: setday(this,[object])
  功能: 主调用函数
  作者: degliu@htomail.com
  时间: 2007年01月13日
  地点: 山东泰华电讯有限责任公司
  示例:
...
strFrame+='<span id=tmpSelectHourLayer  style="z-index: 9999;position: absolute;top: 189; left: 35px;display: none"></span>';
strFrame+='<span id=tmpSelectMinuteLayer style="z-index:9999;position:absolute;top: 189; left: 77px;display: none"></span>';
strFrame+='<span id=tmpSelectSecondLayer style="z-index:9999;position:absolute;top: 189; left: 119px;display: none"></span>';
