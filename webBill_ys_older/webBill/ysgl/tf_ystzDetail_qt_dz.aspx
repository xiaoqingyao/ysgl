<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tf_ystzDetail_qt_dz.aspx.cs" Inherits="webBill_ysgl_tf_ystzDetail_qt_dz" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <title></title>
    <%--这个页面是用于大智定制的，预算调整必须行内金额平衡，不能跨科目调整（不占用预算的并且不是退费的科目）--%>
...
<body>
    <form id="form1" runat="server">
        <div class="baseDiv">
            <div>
                <input type="button" value="返回列表页" id="btn_fh" runat="server" onclick="window.location.href = 'ystz_qt_dz.aspx?isdz=1'" class="baseButton" />
                ...
                财年：<asp:DropDownList ID="ddlNd" runat="server" OnSelectedIndexChanged="ddlNd_SelectedIndexChanged"  AutoPostBack="True"></asp:DropDownList>
                ...
                <div style="border-bottom: 1px dashed #CDCDCD; margin-top: 5px;">
                    ...
                    <span style="color:red">调整规则：必须保证年预算总额不变。<%--调整规则：预算额度不可以跨科目调整，必须保证科目年预算总额不变。--%></span>
                </div>
            </div>
                        ...
                        <td>
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="baseTable" ShowHeader="true" OnRowDataBound="GridView1_RowDataBound" OnRowCreated="GridView1_RowCreated">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="km" HeaderText="预算科目22342342" HtmlEncode="false" ItemStyle-Wrap="false" />
