<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yszjList_bykm.aspx.cs" Inherits="ysgl_yszjList_bykm" %>
    ...
    <script language="javascript" type="Text/javascript">
        $(function () {
            ...
            $("#btn_look").click(function () {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                openDetail("yszjAdd_bykm.aspx?type=look&billCode=" + billcode);
            });
                    ...
                    <div id="divgrid" style="overflow-x: auto;">
                        <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="billName" HeaderText="单据编号" HeaderStyle-Width="200" ItemStyle-Width="200">
