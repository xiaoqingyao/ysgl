<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yszjkmtj.aspx.cs" Inherits="webBill_ysgl_yszjkmtj" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>预算追加科目统计</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
    <base target="_self" />
...
<body style="background-color: #EBF2F5;">
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td>
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3" CssClass="myGrid" Width="100%">
                        <Columns>
