<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ystzDetailLook.aspx.cs" Inherits="webBill_ysgl_ystzDetailLook" %>
    ...
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="0">
            <tr id="trResult" runat="server">
                <td style="height: 22px">&nbsp;<asp:Button
                ...
                <td>
                    <asp:DataGrid ID="myGrid1" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="je" HeaderText="调整后金额" DataFormatString="{0:F2}">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
