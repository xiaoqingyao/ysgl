<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ystz_tf_dz.aspx.cs" Inherits="webBill_ysgl_ystz_tf_dz" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $(function () {
            ...
            $("#btn_look").click(function () {
                ...
                window.location.href = "tf_ystzDetail_dz.aspx?type=look&deptcode=" + vardeptcode + "&billCode=" + billcode;
            ...
            $("#btn_insert").click(function () {
                var isdz = '<%=Request["isdz"]%>';
                var vardeptcode = $("#LaDept").val();
                window.location.href = "tf_ystzDetail_dz.aspx?type=add&deptcode=" + vardeptcode;
            });
            $("#btn_edit").click(function () {
                ...
                window.location.href = "tf_ystzDetail_dz.aspx?type=edit&billCode=" + billcode + "&deptcode=" + vardeptcode;
