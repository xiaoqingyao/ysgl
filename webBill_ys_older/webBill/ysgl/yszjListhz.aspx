<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yszjListhz.aspx.cs" Inherits="ysgl_yszjListhz" %>
    ...
    <script language="javascript" type="Text/javascript">
        $(function () {
            ...
            $("#btn_delete").click(function () {
                ...
                $.post("../MyAjax/DeleteBill.ashx", { "billCode": billcode, "type": "yszjhz" }, function (data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
            ...
            $("#btn_look").click(function () {
                ...
                var url = "yszjAddhz.aspx?type=look&billCode=" + billcode;
                if (isxm != "" & isxm == "1") {
                    var xmcode = checkrow.find("td")[8].innerHTML;
                    url += "&xmcode=" + xmcode;
                }
                openDetail(url);
            });
            ...
            $("#btn_replace").click(function () {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "yszjhz" }, function (data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("提交成功！");
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <asp:Button ID="Button6" runat="server" Text="刷  新" CssClass="baseButton" OnClick="Button6_Click" />
                    ...
                    <asp:Button ID="btn_edit" runat="server" Text="修  改" OnClientClick="return editCheck()"  Visible="false"
                        ...
                        <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="xm" HeaderText="项目" HeaderStyle-Width="150" ItemStyle-Width="150">
                                   ...
                                   <asp:BoundColumn DataField="note3" HeaderText="项目" HeaderStyle-Width="150" ItemStyle-Width="150">
