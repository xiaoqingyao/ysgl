...
public partial class webBill_ysgl_tf_ystzDetail_dz : BasePage
{
    ...
    private void bindData()
    {
        ...
        if (ctrl.Equals("add") || ctrl.Equals("edit"))
        {
            ...
            IList<Models.YsgcTb> list = bllMain.GetMainTable_tf(deptcode, nd, this.ddlYsType.SelectedValue, "01", new string[] { "1", "2", "3", "4", "5", "8" }, "all", "end");
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType != DataControlRowType.Header && e.Row.RowType != DataControlRowType.Footer)
        {
            ...
            decimal f2 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[4].FindControl("txtFebruary")).Text.Trim(), out f2);
            decimal f3 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[6].FindControl("txtmarch")).Text.Trim(), out f3);
            decimal f4 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[8].FindControl("txtApril")).Text.Trim(), out f4);
            decimal f5 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[10].FindControl("txtMay")).Text.Trim(), out f5);
            decimal f6 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[12].FindControl("txtJune")).Text.Trim(), out f6);
            decimal f7 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[14].FindControl("txtJuly")).Text.Trim(), out f7);
            decimal f8 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[16].FindControl("txtAugust")).Text.Trim(), out f8);
            decimal f9 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[18].FindControl("txtSeptember")).Text.Trim(), out f9);
            decimal f10 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[20].FindControl("txtOctober")).Text.Trim(), out f10);
            decimal f11 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[22].FindControl("txtNovember")).Text.Trim(), out f11);
            decimal f12 = 0;
            decimal.TryParse(((TextBox)e.Row.Cells[24].FindControl("txtDecember")).Text.Trim(), out f12);
            ...
            //控制非末级科目行  隐藏文本框 改变颜色
            string kmbh = ((HiddenField)e.Row.Cells[28].FindControl("HiddenKmbh")).Value;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            TextBox txtyear = (TextBox)GridView1.Rows[i].Cells[26].FindControl("txtYear");
            TextBox txtYear_to = (TextBox)GridView1.Rows[i].Cells[27].FindControl("txtYear_to");
        ...
        if (ctrl == "add")
        {
            ...
            if (!string.IsNullOrEmpty(strtzcs))
            {
                ...
                if (strcount >= inttzcs)
                {
                    ClientScript.RegisterStartupScript(this.GetType(), "a", "alert('本月已经做过调整不允许多次调整，系统将跳转至列表页……');window.location.href='ystz_tf_dz.aspx?isdz=1'", true);
                    return;
                }
            }
        }
        ...
        ClientScript.RegisterStartupScript(this.GetType(), "a", "alert('保存成功，系统将跳转至列表页……');window.location.href='ystz_tf_dz.aspx?isdz=1'", true);
    }
    ...
    private List<Bill_Ysmxb> getTzMx()
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            ...
            string txtYsYear = ((TextBox)GridView1.Rows[i].Cells[26].FindControl("txtYear")).Text.Trim();
            decimal fYs1 = 0;
            ...
            string txtTzYear = ((TextBox)GridView1.Rows[i].Cells[27].FindControl("txtYear_to")).Text.Trim();
            decimal fTz1 = 0;
