<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yszjshList.aspx.cs" Inherits="ysgl_yszjshList" %>
...
<head runat="server">
    ...
    <script language="javascript" type="Text/javascript">
        ...
        {
            window.showModalDialog(openUrl, 'newwindow', 'center:yes;dialogHeight:600px;dialogWidth:550px;status:no;scroll:no');
        }
    </script>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="height: 27px">
                    ...
                    <asp:Button ID="Button3" runat="server" Text="详细信息" CssClass="baseButton" OnClick="Button3_Click" /></td>
            </tr>
            <tr>
                <td>
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        <Columns>
                          <asp:TemplateColumn HeaderText="选择">
                            ...
                            <asp:BoundColumn DataField="billName" HeaderText="预算过程" Visible="false">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                            ...
                            <asp:BoundColumn DataField="billJe" DataFormatString="{0:F2}" HeaderText="追加金额">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
