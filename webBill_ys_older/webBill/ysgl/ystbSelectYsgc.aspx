<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ystbSelectYsgc.aspx.cs" Inherits="webBill_ysgl_ystbSelectYsgc" %>
...
<head runat="server">
    ...
    <script language="javascript" type="Text/javascript">
        ...
        function tbCheck() {
            ...
            var zt = checkrow.find("td")[11].innerHTML;
            if (zt != "进行中") {
                alert("该预算过程没有开始,不能填报！");
                return false;
            }
            var billcode = checkrow.find("td")[2].innerHTML;
            $("#hd_billCode").val(billcode);
            var deptcode = checkrow.find("td")[0].innerHTML;
            $("#hd_deptcode").val(deptcode);
            return true;            
        }
    </script>
</head>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="height: 27px">
                    &nbsp;
                    &nbsp;<asp:Button ID="Button2" runat="server" Text="确认填报" CssClass="baseButton" OnClick="Button2_Click" OnClientClick=" return tbCheck();" />
                    &nbsp 部门：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                    ...
                    <asp:Label ID="Label1" runat="server" Text="选择预算过程" ForeColor="Red"></asp:Label>
                ...
                <td>
                    ...
                    CellPadding="3" CssClass="myGrid" PageSize="17" >
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="fqsj" HeaderText="过程发起时间" DataFormatString="{0:D}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" CssClass="myGridItem" />
                            ...
                            <asp:BoundColumn DataField="nian" HeaderText="预算年份">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" CssClass="myGridItem" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="yue" HeaderText="预算季度/月份">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" CssClass="myGridItem" />
