<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ysnzjList.aspx.cs" Inherits="webBill_ysgl_ysnzjList" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $("#<%=myGrid.ClientID%> tr").filter(":not(:has(table, th))").click(function () {
            ...
            $("#btn_look").click(function () {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                var gcbh = $("#LaDept").val();
                openDetail("ysnzjEdit.aspx?type=look&billCode=" + billcode + "&gcbh=" + gcbh);
            });
            ...
            $("#btn_replace").click(function () {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "ysnzj" }, function (data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("撤销成功！");
            ...
            $("#btn_summit").click(function () {
                ...
                if (zt != "未提交") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "ysnzj" }, function (data, status) {
                        if (status == "success") {
                            if (data == "-1") {
        ...
        function openDetail(openUrl) {
            var returnValue = window.showModalDialog(openUrl, 'newwindow', 'center:yes;dialogHeight:600px;dialogWidth:700px;status:no;scroll:yes');
            ...
            <tr>
                ...
                <asp:Button ID="Button6" runat="server" Text="刷  新" CssClass="baseButton" OnClick="Button6_Click" />
                    ...
                    <asp:Button ID="btn_edit" runat="server" Text="修  改" OnClientClick="return editCheck()"
                        OnClick="btn_edit_Click" CssClass="baseButton" Visible="false" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="billDate" DataFormatString="{0:D}" HeaderText="制单日期" HeaderStyle-Width="150" ItemStyle-Width="150">
                                    <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                        Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                    <ItemStyle CssClass="myGridItem" Font-Italic="False" Font-Overline="False"
                                        Font-Strikeout="False" Font-Underline="False" Wrap="False" HorizontalAlign="Center" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="billJe" DataFormatString="{0:N2}" HeaderText="追加金额" HeaderStyle-Width="150" ItemStyle-Width="150">
                                    <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                        Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
