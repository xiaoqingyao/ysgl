<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kmystzlist.aspx.cs" Inherits="webBill_ysgl_kmystzlist" %>
...
<head id="Head1" runat="server">
    <title>科目预算调整</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
        ...
        $(this).keypress(function(event) {
          ...
          initMainTableClass("<%=myGrid.ClientID%>");
            ...
            $("#btn_look").click(function() {
                ...
                openDetail("KmYstzDetail.aspx?Ctrl=View&billCode=" + billcode + "&deptcode=" + deptcode);
            });
            $("#btn_delete").click(function() {
                ...
                var hdKmystzNeedAudit = $("#hd_KmystzNeedAudit").val();
                if (zt != "未提交" && !(zt == "审批通过" && hdKmystzNeedAudit == "0")) {
                    alert("该行已提交,不能删除！");
                    return;
                }
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                $.post("../MyAjax/DeleteBill.ashx", { "billCode": billcode, "type": "kmystz" }, function(data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
            ...
            $("#btn_replace").click(function() {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "kmystz" }, function(data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("撤销成功！");
            ...
            $("#btn_summit").click(function() {
                ...
                if (zt != "未提交") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "kmystz" }, function(data, status) {
                        if (status == "success") {
                            if (data == "-1") {
            ...
            $("#btn_insert").click(function() {
                var deptcode = $("#LaDept").val();
                openDetail("KmYstzDetail.aspx?Ctrl=Add&deptcode=" + deptcode);
                $("#Button6").click();
            });
            $("#btn_edit").click(function() {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                var deptcode = $("#LaDept").val();
                openDetail("KmYstzDetail.aspx?Ctrl=Edit&billCode=" + billcode + "&deptcode=" + deptcode);
                $("#Button6").click();
            });
        });
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 30px">
                <asp:Label ID="Label1" runat="server" ForeColor="Red">科目预算调整</asp:Label>&nbsp; 
                部门：<asp:DropDownList
                ...
                <input id="btn_edit" value="修 改" class="baseButton" type="button" />
                ...
                <div id="divgrid" style="overflow-x: auto;">
                     <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="stepid" HeaderText="完成审核"  HeaderStyle-Width="150" ItemStyle-Width="150">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem"    Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" Wrap="true" />
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:HiddenField ID="hd_KmystzNeedAudit" runat="server" />
                        </td>
                        <td id="wf">
                        </td>
                    </tr>
