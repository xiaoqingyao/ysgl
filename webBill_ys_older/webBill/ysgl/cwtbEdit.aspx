<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cwtbEdit.aspx.cs" Inherits="webBill_ysgl_cwtbEdit" %>
...
<head runat="server">
    ...
    <script language="javascript" type="Text/javascript">
        ...
        function openUpLoad(obj)
        {
            ...
            var returnValue=window.showModalDialog('cwtbSmFj.aspx?type=edit&billCode='+billCode+'&yskm='+yskm+'', 'newwindow', 'center:yes;dialogHeight:30px;dialogWidth:460px;status:no;scroll:yes');
            ...
            {
                var fj=webBill_ysgl_cwtbEdit.getFj(billCode,yskm).value;
        ...
        function deleteFj(obj)
        {
            ...
            var fj=webBill_ysgl_cwtbEdit.deleteFj(billCode,yskm).value;
            if(fj==true)
            {
        ...
        function calLj(obj)
        {
            ...
            var list=webBill_ysgl_cwtbEdit.getCalResult(currentCode,arrIndex,arrCode,arrVal).value;
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        CssClass="myGrid" Width="525px" OnItemDataBound="myGrid_ItemDataBound">
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="tbsm" HeaderText="填报说明" Visible="false">
                                ...
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                            </asp:BoundColumn> <asp:TemplateColumn HeaderText="填报类型">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                            ...
                            </asp:TemplateColumn><asp:TemplateColumn HeaderText="说明">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                            ...
                            <asp:TemplateColumn HeaderText="附件">
                                ...
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemTemplate>
                                    <input id="btnUpLoad" class="baseButton" type="button" runat="server" value="上传附件" onclick="openUpLoad(this);" />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            ...
                            <asp:BoundColumn DataField="je" HeaderText="原来预算金额" DataFormatString="{0:F2}" Visible="False">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItemRight" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" Wrap="False" HorizontalAlign="Right" />
