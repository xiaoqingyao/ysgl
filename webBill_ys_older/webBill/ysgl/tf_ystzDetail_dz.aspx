<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tf_ystzDetail_dz.aspx.cs" Inherits="webBill_ysgl_tf_ystzDetail_dz" %>
...
<body>
    <form id="form1" runat="server">
        <div class="baseDiv">
            <div>
                <input type="button" value="返回列表页" id="btn_fh" runat="server" onclick="window.location.href = 'ystz_tf_dz.aspx?isdz=1'" class="baseButton" />
