<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xjllb_set.aspx.cs" Inherits="webBill_tjbb_dz_xjllb_set" %>
            ...
            <table class="baseTable">
                ...
                <tr>
                    ...
                    <td colspan="4">
                        ...
                        <asp:Button ID="btn_Save" runat="server" Text="保 存" OnClick="btn_Save_Click" CssClass="baseButton" /></td>
                ...
                <tr>
                    ...
                    <td>4</td>
                    <td>
                        <asp:TextBox ID="bqys_4" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_4" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_4" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_4" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>14</td>
                    <td>
                        <asp:TextBox ID="bqys_14" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_14" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_14" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_14" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>16</td>
                    <td>
                        <asp:TextBox ID="bqys_16" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_16" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_16" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_16" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>17</td>
                    <td>
                        <asp:TextBox ID="bqys_17" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_17" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_17" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_17" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>18</td>
                    <td>
                        <asp:TextBox ID="bqys_18" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_18" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_18" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_18" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>20</td>
                    <td>
                        <asp:TextBox ID="bqys_20" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_20" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_20" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_20" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>21</td>
                    <td>
                        <asp:TextBox ID="bqys_21" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_21" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_21" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_21" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>22</td>
                    <td>
                        <asp:TextBox ID="bqys_22" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_22" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_22" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_22" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>23</td>
                    <td>
                        <asp:TextBox ID="bqys_23" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_23" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_23" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_23" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                ...
                <tr>
                    ...
                    <td>25</td>
                    <td>
                        <asp:TextBox ID="bqys_25" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_25" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_25" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_25" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>26</td>
                    <td>
                        <asp:TextBox ID="bqys_26" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_26" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_26" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_26" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>27</td>
                    <td>
                        <asp:TextBox ID="bqys_27" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_27" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_27" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_27" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>29</td>
                    <td>
                        <asp:TextBox ID="bqys_29" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_29" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_29" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_29" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>30</td>
                    <td>
                        <asp:TextBox ID="bqys_30" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_30" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_30" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_30" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
                <tr>
                    ...
                    <td>31</td>
                    <td>
                        <asp:TextBox ID="bqys_31" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="bqjs_31" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljys_31" runat="server" /></td>
                    <td>
                        <asp:TextBox ID="ljjs_31" runat="server" /></td>
                    <td>
                        <input type="button" value="设置" onclick="selectyskm(this);" /></td>
                </tr>
            </table>
