<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Selectdept.aspx.cs" Inherits="webBill_tjbb_dz_Selectdept" %>
    ...
    <form id="form1" runat="server">
        <div style="overflow: auto; height: 380px;">
            <asp:TreeView ID="TreeView1" runat="server" ShowLines="True" ExpandDepth="2" >
                <Nodes>
                    <asp:TreeNode ImageUrl="../Resources/Images/treeView/treeHome.gif" Checked="false" SelectAction="Select"
                        Text="预算部门" Value=""></asp:TreeNode>
                </Nodes>
            </asp:TreeView>
        </div>
