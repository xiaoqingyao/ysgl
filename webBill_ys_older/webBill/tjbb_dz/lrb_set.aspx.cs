...
public partial class webBill_tjbb_dz_lrb_set : System.Web.UI.Page
{
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        sqls.Add("delete from dz_zcfzb where zth='" + this.ddlZt.SelectedValue + "' and flg='lrb'");
        for (int i = 0; i < 65; i++)
        {
            ...
            sqltemp = string.Format(sqltemp, zth, i, bqys, bqjs, ljys, ljjs, kmbhs, "lrb");
            //if (i == 3)
            //{
            //    Response.Write(qmys);
            //    Response.Write(qmjs);
    ...
    private void initData()
    {
        ...
        for (int i = 1; i < 65; i++)
        {
            ...
            if (bqys != null)
            {
                string sqlTemp = string.Format("select * from dz_zcfzb where flg='lrb' and   zth='" + zth + "' and id='{0}'", i);
