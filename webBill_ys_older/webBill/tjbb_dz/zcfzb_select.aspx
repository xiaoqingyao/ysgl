<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zcfzb_select.aspx.cs" Inherits="webBill_tjbb_dz_zcfzb_select" %>
            ...
            <table cellpadding="0" id="taball" cellspacing="0" width="100%" style="margin: 0 auto">
                ...
                <tr>
                    <td style="text-align: center; height: 27px;">
                        <strong><span style="font-size: 12pt"><%=title %>-选择时间区间</span></strong>
                    </td>
                </tr>
                <tr>
