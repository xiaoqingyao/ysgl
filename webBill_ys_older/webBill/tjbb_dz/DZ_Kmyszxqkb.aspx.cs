...
public partial class webBill_tjbb_dz_DZ_Kmyszxqkb : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Dz_KmfyqkListTable.aspx?kssj=" + kssj + "&jzsj=" + jzsj + "&deptCode=" + dept + "&type=" + type + "&dydj=" + strdydj);
    }
