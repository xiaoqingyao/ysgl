...
public partial class webBill_tjbb_dz_Dz_BmfyqkListTable : System.Web.UI.Page
{
    ...
    public void bindData()
    {
        ...
        string strsql = @"exec bill_pro_fyqkb_new_dz_dept '" + Convert.ToDateTime(kssj) + "','" + Convert.ToDateTime(jzsj) + "','" + dept + "','" + type + "','" + strdydj + "','" + strismj + "'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("DZ_Bmyszxqkb.aspx?dydj=" + strdydj);
    }
