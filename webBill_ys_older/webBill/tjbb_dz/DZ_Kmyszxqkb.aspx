<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DZ_Kmyszxqkb.aspx.cs" Inherits="webBill_tjbb_dz_DZ_Kmyszxqkb" %>
            ...
            <table cellpadding="0" id="taball" cellspacing="0" width="100%" style="margin: 0 auto">
                ...
                <tr>
                    <td style="text-align: center; height: 27px;">
                        <strong><span style="font-size: 12pt">科目预算执行情况查询</span></strong>
                    </td>
                </tr>
                <tr>
