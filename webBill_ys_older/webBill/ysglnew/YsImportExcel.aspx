<%@ Page Language="C#" AutoEventWireup="true" CodeFile="YsImportExcel.aspx.cs" Inherits="webBill_ysgl_YsImportExcel" %>
        ...
        <div class="baseDiv">
            ...
            <table class="myTable" width="100%">
                <tr>
                    ...
                    <td>
                        <a href="YSImport.xls" class="baseButton" target="_blank" style="display: block; text-align: center; width: 45px">导出</a>
                    </td>
                </tr>
                <tr>
                    <td class="style1">导入：
