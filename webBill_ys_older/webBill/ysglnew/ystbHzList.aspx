<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ystbHzList.aspx.cs" Inherits="webBill_ysglnew_ystbHzList" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        function editCheck() {
            if ($("#drpSelectNd").val() == "0") {
                ...
                openDetail("cwtbDetail.aspx?deptCode=" + deptcode + "&nd=" + $("#drpSelectNd").val() + "&type=ystb" + "&yskmtype=" + yskmtype + "&tbtype=" + tbtype + "&limittotal=" + limittotal + "&jecheckflg=" + jecheckflg);
                return false;
            }
        }
        ...
        function lookCheck() {
            if ($("#drpSelectNd").val() == "0") {
                ...
                var billcode = $(".highlight").find("td").eq(1).html();
                var xmcode = "";
                if ($(".highlight").find("td").eq(11).html() != undefined && $(".highlight").find("td").eq(11).html() != "&nbsp;") {
                    xmcode = $(".highlight").find("td").eq(11).html();
                }

                if (billcode == null || billcode == undefined || billcode == '') {
                    alert("请先选中一行记录。");
                } else {
                    //  ystbHzDetail.aspx?deptCode=" + deptcode + "&nd=" + nd + "&tbtype=" + tbtype + "&xmcode=" + str_xmCode
                    window.location.href = "ystbHzDetail.aspx?ctrl=view&billcode=" + billcode + "&xmcode=" + xmcode;
                }
                return false;
            }
        }
        ...
        function gotoAdd() {
            ...
            if ($("#drpSelectNd").val() == "0") {
                ...
                var limittotal = '<%= Request["limittotal"]%>';
                var jecheckflg = '<%=Request["jecheckflg"]%>';
                var xmys = '<%=Request["xmys"]%>';//是否是项目预算
                var nd = $("#drpSelectNd").val();
                if (xmys == "1") {//项目预算
                    openDetail("../xmsz/xmList.aspx?deptCode=" + deptcode + "&nd=" + nd + "&tbtype=" + tbtype + "&xmys=" + xmys);

                } else {
                    openDetail("ystbHzDetail.aspx?deptCode=" + deptcode + "&nd=" + nd + "&tbtype=" + tbtype);
                    ...
                    <div id="divgrid" style="overflow-x: auto;">
                        <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="xmbh" HeaderText="项目" HeaderStyle-Width="160" ItemStyle-Width="160">
                                    <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                        Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                    <ItemStyle CssClass="myGridItem" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
                                </asp:BoundColumn>
                                   <asp:BoundColumn DataField="xmbh" HeaderText="项目编号" HeaderStyle-Width="160" ItemStyle-Width="160">
                                    <HeaderStyle CssClass="hiddenbill" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                        Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                    <ItemStyle CssClass="hiddenbill" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
