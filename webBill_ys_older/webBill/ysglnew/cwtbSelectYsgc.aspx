<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cwtbSelectYsgc.aspx.cs" Inherits="webBill_ysglnew_cwtbSelectYsgc" %>
   ...
   <base target="_self" />
    ...
    <script language="javascript" type="Text/javascript">
        ...
        function tbCheck() {
            ...
            var zt = checkrow.find("td")[9].innerHTML;
            if (zt != "进行中") {
                alert("该预算过程没有开始,不能填报！");
                return false;
            }
            var billcode = checkrow.find("td")[0].innerHTML;
            var billname = checkrow.find("td")[1].innerHTML;
            window.returnValue = "["+billcode+"]"+billname;
            window.close();
            return false;
//            $("#hd_billCode").val(billcode);
//            return true;
