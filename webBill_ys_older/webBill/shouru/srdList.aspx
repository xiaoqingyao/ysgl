<%@ Page Language="C#" AutoEventWireup="true" CodeFile="srdList.aspx.cs" Inherits="webBill_shouru_srdList" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 30px">
                ...
                <asp:Button ID="Button6" runat="server" CssClass="baseButton hiddenbill" OnClick="Button6_Click1"  
                    Text="打印预览" />
            ...
            <td>
                <div id="divgrid" style="overflow-x: auto; position: relative; word-warp: break-word;
                    ...
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        OnItemDataBound="myGrid_ItemDataBound" AllowPaging="True" PageSize="17" ShowFooter="false">
                        <Columns>
