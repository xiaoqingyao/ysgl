<%@ Page Language="C#" AutoEventWireup="true" CodeFile="srdDetail.aspx.cs" Inherits="webBill_bxgl_bxDetailForGK" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $(function() {
                ...
                $.post("../MyAjax/YbbxBillSaveForGkfj.ashx?type=" + type + "&iscommit=" + iscommit, json, function(data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            ...
                            alert("该收入类型需要附单据,请添加单据!");
                        }
                        else if (data == "-4") {
                            alert("修改单据日期不能跨月!");
                        }
                        else if (data == "-5") {
                            alert("该收入科目有部门核算，请选择使用部门!");
                        }
                        else if (data == "-6") {
                            alert("该收入科目有项目核算，请选择使用项目!");
                        }
                        else if (data == "-7") {
            ...
            function jsonMaker() {
                ...
                var varphone = $("#txtbxrdh").val(); //收入人电话
                var varzh = $("#txtbxzh").val(); //收入人账号
                var varkhh = $("#txt_khh").val(); //开户行
                varzh = varkhh + "|&|" + varzh;
                var varbxr2 = $("#txtbxr2").val(); //收入人
                ...
                var djs = '0';
                var ret = '{"djlx":"' + djtype + '","bxr":"' + usercode + '","billuser":"' + bxr + '","bxrzh":"' + varzh + '","bxr2":"' + varbxr2 + '","bxrphone":"' + varphone + '","zy":"' + bxzy + '","sm":"' + bxsm + '","bxlx":"' + bxlx + '","gkbmbh":"' + gkbmbh + '","billname":"' + billname + '","fysq":"' + fysqCode + '","bxDate":"' + bxDate + '","sfgf":"0","djs":"' + djs + '","isgk":"' + isgk + '","list":[';
            ...
            $("#btn_choosexm").click(function() {
                ...
                if (current.text().indexOf("是") == -1) {
                    alert("该收入科目没有启用项目核算，请先到预算科目菜单修改此科目的属性！");
                    return;
                }
                var checkRowid = $("#tab_fykm .highlight").attr("id");
                    ...
                    <div style="margin: 0 auto; width: 98%;">
                        <table border="0" cellpadding="2" cellspacing="0" class="myTable" width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="7">
                                    <asp:RadioButton ID="rb_ok" runat="server" Text="归口填报" GroupName="is_gk" Checked="true" />
                                    <asp:RadioButton ID="rb_can" runat="server" Text="本部填报" GroupName="is_gk" Enabled="false" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="tableBg2">
                                ...
                                <td colspan="2">
                                    ...
                                    <input type="button" value="选择收入科目" id="btnAddFykm" runat="server" class="baseButton" />
                                    <span style="color: Red">*</span>
                                </td>
                                <td colspan="5">
                                    <input type="button" value="选择归口部门" id="selectbxdept" runat="server" class="baseButton" /><span
                                        style="color: Red">*</span>
                                        <span  style="color: Red">如果您难以确定收入科目，请<a onclick="showhelpmsg();" href="#" style="color:Blue">点我<a/>。</span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="tableBg2">
