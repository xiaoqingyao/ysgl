<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bxglFrame.aspx.cs" Inherits="webBill_bxgl_bxList" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $(function () {
            ...
            $("#btn_edit").click(function () {
                ...
                var djmxlx = '<%=Request["djmxlx"]%>';
                var isDz = '<%=Request["isDz"]%>';

                openDetail("bxDetailFinal.aspx?type=edit&billCode=" + billcode + "&dydj=" + dydj + "&djlx=" + djlx + "&djmxlx=" + djmxlx + "&isDz=" + isDz);
                //window.location.href = "bxDetailFinal.aspx?type=edit&billCode=" + billcode + "&isDz=" + isDz;
            });
            ...
            $("#btn_look").click(function () {
                ...
                var dydj = '<%=Request["dydj"] %>';
                var djlx = '<%=Request["djlx"]%>';
                var djmxlx = '<%=Request["djmxlx"]%>';//单据明细类型
                var isDz = '<%=Request["isDz"]%>';
                openDetail("bxDetailFinal.aspx?type=look&billCode=" + billcode + "&dydj=" + dydj + "&djlx=" + djlx + "&djmxlx=" + djmxlx + "&isDz=" + isDz);
                //window.location.href = "bxDetailFinal.aspx?type=look&billCode=" + billcode + "&dydj=" + dydj + "&djlx=" + djlx + "&djmxlx=" + djmxlx + "&isDz=" + isDz;
            });
            ...
            $("#btn_print").click(function () {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                var je = 0;
                je = checkrow.find("td")[5].innerHTML;
                var dydj = '<%=Request["dydj"]%>';
                var isDZ = '<%=Request["isDZ"]%>';
                if (dydj.length > 0) {
                    if (dydj == "06" & isDZ == "1") {
        ...
        function openDetail(openUrl) {
            ...
            var returnValue = window.showModalDialog(openUrl, 'newwindow', 'center:yes;dialogHeight:600px;dialogWidth:980px;status:no;scroll:yes');
            if (returnValue == undefined || returnValue == "") {
                return false;
            }
            else {
        ...
        function OpenAdd() {
            ...
            var isDZ = '<%=Request["isDZ"]%>';
            var url = 'bxDetailFinal.aspx?type=add&par=' + Math.random();
            if (dydj != undefined && dydj != null && dydj != "") {
                url += '&dydj=' + dydj;
            }
                    ...
                    <div id="divgrid" style="overflow-x: auto;">
                        <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" Width="1400px"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="billUserName" HeaderText="报销人" HeaderStyle-Width="150"
                                    ItemStyle-Width="150">
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                    <ItemStyle Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
