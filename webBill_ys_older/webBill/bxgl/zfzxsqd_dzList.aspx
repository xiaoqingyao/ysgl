<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zfzxsqd_dzList.aspx.cs" Inherits="webBill_bxgl_zfzxsqd_dzList" %>
    ...
    <script language="javascript" type="Text/javascript">
        $(function () {
            ...
            $("#btn_print").click(function () {
                ...
                window.open("zfzxsqdprint_dz.aspx?billCode=" + billcode + "&flg=" + flg);
        ...
        function editCheck() {
            ...
            if (billcode == null || billcode == undefined || billcode == '') {
                ...
                openDetail("zfzxsqd_dzDetails.aspx?ctrl=edit&billcode=" + billcode + "&flg=" + flg);
            }
            return false;
        ...
        function lookCheck() {
            ...
            if (billcode == null || billcode == undefined || billcode == '') {
                ...
                openDetail("zfzxsqd_dzDetails.aspx?ctrl=view&billcode=" + billcode + "&flg=" + flg);
            }
            return false;
        }
        function openDetail(openUrl) {
            var returnValue = window.showModalDialog(openUrl, 'newwindow', 'center:yes;dialogHeight:500px;dialogWidth:1200px;status:no;scroll:yes');
            if (returnValue == "1") {
        ...
        function gotoAdd() {
            ...
            if ($("#drpSelectNd").val() == "0") {
                ...
                openDetail("zfzxsqd_dzDetails.aspx?ctrl=add&flg=" + flg);
                return false;
            }
        }
