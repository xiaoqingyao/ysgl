<%@ Page Language="C#" AutoEventWireup="true" CodeFile="selectlscg.aspx.cs" Inherits="webBill_bxgl_selectlscg" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>选择报告单</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
   <base target="_self" />
            ...
            <tr>
                <td>
                    ...
                    申请日期从：<asp:TextBox ID="txb_sqrqbegin" runat="server" Width="80px"></asp:TextBox>至<asp:TextBox
                        ...
                        报告单号：<asp:TextBox ID="txtcode" runat="server" Width="80px"></asp:TextBox>
                ...
                <td>
                    <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="billCode" HeaderText="报告单号"  HeaderStyle-CssClass="myGridHeader" ItemStyle-CssClass="myGridItem"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="yjfy" HeaderText="采购总额" DataFormatString="{0:F2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
