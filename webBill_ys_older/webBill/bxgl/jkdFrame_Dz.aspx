<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jkdFrame_Dz.aspx.cs" Inherits="webBill_bxgl_jkdFrame_Dz" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $(function () {
            ...
            $("#btn_edit").click(function () {
                ...
                var url = "jkDetailForDz.aspx?type=edit&billCode=" + billcode;
            ...
            $("#btn_look").click(function () {
                ...
                var billcode = checkrow.find("td")[2].innerHTML;
                var url = 'jkDetailForDz.aspx?type=look&billCode=' + billcode;
                if (dydj != undefined && dydj != null && dydj != "") {
                    url += '&dydj=' + dydj;
                }
                if (djlx != undefined && djlx != null && djlx != "") {
            ...
            $("#btn_print").click(function () {
                ...
                window.open("tfprint_dz.aspx?billCode=" + billcode + "&dydj=02&je=" + je);
            ...
            $("#btn_summit").click(function () {
                ...
                if (zt != "未提交") {
                    ...
                    $.post("../MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "gkbx", "isdz": "1" }, function (data, status) {
                        if (data == "-1" || data == "-2") {
                            alert("提交失败！");
                        } else if (data == "-3") {
        ...
        function add() {
            ...
            var djmxlx = '<%=Request["djmxlx"]%>';//单据明细类型  就是报销明细类型 是否占用预算是否冲减预算的选项
            var isDZ = '<%=Request["isDZ"]%>';
            var url = 'jkDetailForDz.aspx?type=add&par=' + Math.random();
            if (dydj != undefined && dydj != null && dydj != "") {
                url += '&dydj=' + dydj;
            }
            if (djlx != undefined && djlx != null && djlx != "") {
                    ...
                    <div style="float: left">
                        <table class="baseTable" style="text-align: left;">
                            ...
                            <tr>
                                ...
                                <td>学员姓名：</td>
                                <td>
                                    <asp:TextBox ID="txtStuName" runat="server" Width="120px"></asp:TextBox></td>
                                <td>协议编号：</td>
                                <td>
                                    <asp:TextBox ID="txtXieYi" runat="server" Width="120px"></asp:TextBox></td>

                            </tr>
                            <tr>
                                <td>所在分校：</td>
                                <td>  <asp:TextBox ID="txtFx" runat="server" Width="120px"></asp:TextBox></td>
                               <td>年级：</td>
                                <td>  <asp:TextBox ID="txtNianji" runat="server" Width="120px"></asp:TextBox></td>
                                <td colspan="6">
