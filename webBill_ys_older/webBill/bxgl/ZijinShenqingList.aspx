<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZijinShenqingList.aspx.cs" Inherits="webBill_fysq_ZijinShenqingList" %>
    ...
    <script language="javascript" type="Text/javascript">
        $(function () {
            ...
            $("#btn_delete").click(function () {
                ...
                $.post("../MyAjax/DeleteBill.ashx", { "billCode": billcode, "type": "zjsq" }, function (data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
            ...
            $("#btn_print").click(function () {
                ...
                window.open("ZijinShenqingprint_dz.aspx?billCode=" + billcode);
        ...
        function editCheck() {
            ...
            if (billcode == null || billcode == undefined || billcode == '') {
                ...
                openDetail("ZijinShenqingDetails.aspx?ctrl=edit&billcode=" + billcode);
            }
            return false;
        ...
        function lookCheck() {
            ...
            if (billcode == null || billcode == undefined || billcode == '') {
                ...
                openDetail("ZijinShenqingDetails.aspx?ctrl=view&billcode=" + billcode);
            }
            return false;
        }
        ...
        function gotoAdd() {
            ...
            if ($("#drpSelectNd").val() == "0") {
                ...
                openDetail("ZijinShenqingDetails.aspx?ctrl=add");
                return false;
            }
        }
