<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qtbxDetail.aspx.cs" Inherits="webBill_bxgl_qtbxDetail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>其他费用报销单</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
    <base target="_self" />
    ...
    <script language="javascript" type="Text/javascript" >
        $(function() {
            ...
            function jsonMaker() {
                ...
                var djs = $("#txt_djs").val();
                var ret = '{"djlx":"qtbx","billuser":"' + usercode + '","bxr":"' + bxr + '","zy":"' + bxzy + '","sm":"' + bxsm + '","bxlx":"' + bxlx + '","gkbmbh":"' + gkbmbh + '","billcode":"' + billcode + '","fysq":"' + fysqCode + '","bxDate":"' + bxDate + '","sfgf":"0","djs":"' + djs + '","list":[';
    ...
    <form id="form1" runat="server">
        <table cellpadding="0" id="taball" cellspacing="0" class="style1" width="100%">
            <tr>
                <td style="text-align: center; height: 26px;">
                    <strong>其 他 费 用 报 销 单<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                    </strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="5" id="gkbm">
                    <div id ='dv_gk'><span> 归口部门: <input  type='text' id='txt_gk' runat="server"/></span></div>
                </td>
            </tr>
            <tr>
                <td colspan="2" class="tableBg2">
                ...
                <td colspan="9">
                    <table id="cgdj" width="100%">
                        <thead class="myGridHeader">
                            <tr>
                                <td>单据编号</td><td>采购单位</td><td>承办人</td><td>申请日期</td><td>申请类别</td><td>采购总额</td><td>原因说明</td><td>单据状态</td>
                            </tr>
                        </thead>
        ...
        <tr>
            <td style="text-align: center; height: 30px;">
                ...
                <asp:Button ID="btn_kmselect" runat="server" Text="Button" 
                    onclick="btn_kmselect_Click" CssClass="hiddenbill" />
                <input type="button" value="保 存" id="btn_test" class="baseButton" runat="server" />
                &nbsp; &nbsp; &nbsp; &nbsp;
                <input type="button" onclick="javascript:window.close();" value="关 闭" class="baseButton" /></td>
        </tr>
        <tr>
            <td style="text-align: center">
