<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ybbxSetDept.aspx.cs" Inherits="webBill_bxgl_ybbxSetDept" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>一般报销费用科目单位</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
    <base target="_self" />
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr style="display: none;">
                <td style="height: 27px" id="resultButton" runat="server">
                    ...
                    <asp:Button ID="btnRefresh" runat="server" Text="刷新数据" CssClass="baseButton" OnClick="Button1_Click" /></td>
            </tr>
            <tr style="display: none;">
            ...
            <tr style="display: none;">
                <td style="height: 30px">
                    &nbsp;<asp:LinkButton ID="lBtnFirstPage" runat="server" OnClick="lBtnFirstPage_Click">首 页</asp:LinkButton><asp:LinkButton
                        ID="lBtnPrePage" runat="server" OnClick="lBtnPrePage_Click">上一页</asp:LinkButton>
                    ...
                    <asp:Label ID="lblPageSize" runat="server"></asp:Label>条/页 共<asp:Label ID="lblItemCount"
                        runat="server"></asp:Label>条<asp:Button ID="btnRefresh2" runat="server" Text="刷新数据"
                            CssClass="baseButton" OnClick="btnRefresh2_Click" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td id="selectButton" runat="server" style="text-align: center;">
                    <asp:Button ID="Button1" runat="server" CssClass="baseButton" Text="确 定" OnClick="Button1_Click1" />&nbsp;<asp:Button
                        ID="Button3" runat="server" CssClass="baseButton" Text="取 消" OnClick="Button3_Click" /></td>
            </tr>
        </table>
    </form>
</body>
