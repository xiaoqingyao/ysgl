<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gkbxglFrame.aspx.cs" Inherits="webBill_bxgl_gkbxglFrame" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $(function() {
            ...
            $("#btn_edit").click(function() {
                ...
                openDetail("bxDetailForGK.aspx?type=edit&billCode=" + billcode + "&dydj=" + dydj);
            });
            ...
            $("#btn_look").click(function() {
                ...
                var billcode = checkrow.find("td")[2].innerHTML;
                openDetail("bxDetailForGK.aspx?type=look&billCode=" + billcode);
            });
            ...
            $("#btn_replace").click(function() {
                ...
                for (var i = 0; i < guidlength; i++) {
                    if (varmyguid.rows[i].cells[0].getElementsByTagName("input")[0].checked) {
                        var evebillcode = varmyguid.rows[i].cells[2].innerHTML;
            ...
            $("#btn_print").click(function() {
                ...
                var billcode = checkrow.find("td")[2].innerHTML;
                window.open("../YbbxPrint/GkbxPrint.aspx?billName=" + billcode);
            });
            //打印预览
            ...
            $("#btn_summit").click(function() {
                ...
                for (var i = 0; i < guidlength; i++) {
                    if (varmyguid.rows[i].cells[0].getElementsByTagName("input")[0].checked) {
                        var evebillcode = varmyguid.rows[i].cells[2].innerHTML;
                        var zt = varmyguid.rows[i].cells[8].innerHTML;
                        if (zt != '未提交') {
                            continue;
                        }
                        if (evebillcode.length > 6 && evebillcode != null && evebillcode != undefined) {
        ...
        function add() {
            ...
            window.showModelessDialog('bxDetailForGK.aspx?type=add&par=' + Math.random() + "&dydj=" + dydj, 'newwindow', 'center:yes;dialogHeight:600px;dialogWidth:960px;status:no;scroll:yes');
        }
                ...
                <div id="divgrid" style="overflow-x: auto;">
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="billDept" HeaderText="归口部门" DataFormatString="{0:D}"
                                ItemStyle-Width="100" HeaderStyle-Width="100">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="false" CssClass="myGridHeader" />
                                <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:BoundColumn DataField="bxzy" HeaderText="摘要" ItemStyle-Width="350" HeaderStyle-Width="350">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="false" CssClass="myGridHeader" />
                                <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="false" CssClass="myGridItem" />
                            ...
                            <asp:BoundColumn DataField="isgk" HeaderText="归口报销" ItemStyle-Width="100" HeaderStyle-Width="100">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="false" CssClass="myGridHeader" />
                                <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="false" CssClass="myGridItem" />
                            </asp:BoundColumn>
                            <asp:BoundColumn HeaderText="审批人">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="false" CssClass="myGridHeader" />
                                <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="false" CssClass="myGridItem" />
                            </asp:BoundColumn>
                            <asp:BoundColumn HeaderText="驳回理由" DataField="mind">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="false" CssClass="myGridHeader" />
                                <ItemStyle  Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="false" CssClass="myGridItem" />
