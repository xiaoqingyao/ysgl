<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_bxshFrame.aspx.cs" Inherits="webBill_bxgl_bxshFrame" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>一般报销审核 历史单据</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
...
<body>
    <form id="form1" runat="server">
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3" AllowPaging="true" PageSize="17"
