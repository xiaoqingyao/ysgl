<%@ Page Language="C#" AutoEventWireup="true" CodeFile="clbxDetailForGK.aspx.cs"
    Inherits="webBill_bxgl_clbxDetailForGK" %>
    ...
    <script language="javascript" type="Text/javascript">
        ...
        $(function () {
            ...
            function save(iscommit) {
                ...
                $.post("../MyAjax/clbxBillSaveForGkfj.ashx?type=" + type + "&iscommit=" + iscommit+"&clf=1", json, function (data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("保存成功");
            ...
            function jsonMaker() {
                ...
                gkbmbh = gkbmbh.substring(1, gkbmbh.length); //经办科室
                var bxr2 = $("#txtbxr2").val(); //报销人2
                var bxrdianhua = $("#txtbxrdh").val(); //报销人电话
                var bxrzhanghao = $("#txtbxzh").val(); //报销人账号
                var varkhh = $("#txt_khh").val(); //开户行
                bxrzhanghao = varkhh + "|&|" + bxrzhanghao;

                bxr = bxr.split(']')[0];
                bxr = bxr.substring(1, bxr.length); //预算管理员
                var bxzy = $("#txtBxzy").val(); //报销摘要
                var bxsm = $("#txtBxsm").val(); //报销说明
                var bxlx = $("#drpBxmxlx").val();
                var isgk = $("#rb_ok").attr("checked"); //报销类型
                var bxDate = $("#txtSqrq").val(); //报销日期
                ///出差信息
                var bgtime = $("#txtbegintime").val(); //开始时间
                var edtime = $("#txtendtime").val(); //结束日期
                var vzb = $("#txtzb").val(); //职别
                var txtdjzs = $("#txtdjzs").val(); //单据张数
                var txtts = $("#txtts").val(); //天数
                var txtbz = $("#txtbz").val(); //标准
                var txthsje = $("#txthsje").val(); //伙食费金额
                var txtccfje = $("#txtccfje").val(); //车船费金额
                var txthwfje = $("#txthwfje").val(); //会务费金额
                var txtsfje = $("#txtsfje").val(); //宿费金额
                var txtqtje = $("#txtqitafei").val(); //其它金额
                var vdidianqi = $("#txtdidianqi").val(); //地点起
                var vdidianzhi = $("#txtdidianzhi").val(); //地点止

                var vzidingyifeiname1 = $("#txtzidingyifeiname1").val(); //自定义费name1
                var vzidingyifeiname2 = $("#txtzidingyifeiname2").val(); //自定义费name1

                var vzidingyifeival1 = $("#txtzidingyifeival1").val(); //自定义费val1
                var vzidingyifeival2 = $("#txtzidingyifeival2").val(); //自定义费val2
                ...
                var ret = '{"gfje":"' + gfje + '","zdyfeiname1":"' + vzidingyifeiname1 + '","zdyfeiname2":"' + vzidingyifeiname2 + '","zdyfeival1":"' + vzidingyifeival1 + '","zdyfeival2":"' + vzidingyifeival2 + '","didianzhi":"' + vdidianzhi + '","didianqi":"' + vdidianqi + '","qitaje":"' + txtqtje + '","bxrzhanghao":"' + bxrzhanghao + '","bxr2":"' + bxr2 + '","djlx":"' + djtype + '","bgtime":"' + bgtime + '","edtime":"' + edtime + '","zhibie":"' + vzb + '","djs":"' + txtdjzs + '","tianshu":"' + txtts + '","biaozhun":"' + txtbz + '","huoshifei":"' + txthsje + '","chechuanfei":"' + txtccfje + '","huiwufei":"' + txthwfje + '","zhusufei":"' + txtsfje + '","billuser":"' + bxr + '","bxr":"' + usercode + '","bxrphone":"' + varphone + '","zy":"' + bxzy + '","sm":"' + bxsm + '","bxlx":"' + bxlx + '","gkbmbh":"' + gkbmbh + '","billname":"' + billname + '","fysq":"' + fysqCode + '","bxDate":"' + bxDate + '","sfgf":"0","isgk":"' + isgk + '","list":[';
            ...
            $("#selectbxdept").click(function () {
                ...
                for (var i = 0; i < json.length; i++) {
                    if (deptcode.indexOf(json[i].dept) < 0) {
                    ...
                    <div style="margin: 0 auto; width: 98%;">
                        <table border="0" cellpadding="2" cellspacing="0" class="myTable" width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <input id="txtBxr" style="width: 148px" type="text" runat="server" /><span style="color: Red">*</span>
                                </td>
                                <td class="tableBg2">
                                    经办科室
                                </td>
                                ...
                                <td colspan="9">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txthsje" runat="server"></asp:TextBox><span style="color: Red">*</span>
                                            </td>
                                            <td class="tableBg2">
                                                其它
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtqitafei" runat="server" Width="90%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tableBg2">
                                            ...
                                            <td>
                                                <input id="txtdidianqi" runat="server" type="text" />
                                            </td>
                                            <td class="tableBg2">
                                                目的地
                                            </td>
                                            <td>
                                                <input id="txtdidianzhi" runat="server" type="text" />
                                            </td>
                                            <td class="tableBg2">
                                                会务费
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txthwfje" runat="server"></asp:TextBox><span style="color: Red">*</span>
                                            </td>
                                            <td>
                                                <input id="txtzidingyifeiname1" runat="server" type="text" style="width: 70px" value="自定义名称1" />
                                            </td>
                                            <td>
                                                <input id="txtzidingyifeival1" runat="server" type="text" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tableBg2">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtdjzs" runat="server"></asp:TextBox>
                                            </td>
                                            <td class="tableBg2">
                                                车船费
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtccfje" runat="server"></asp:TextBox><span style="color: Red">*</span>
                                            </td>
                                            <td>
                                                <input id="txtzidingyifeiname2" runat="server" type="text" style="width: 70px" value="自定义名称2" />
                                            </td>
                                            <td>
                                                <input id="txtzidingyifeival2" type="text" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tableBg2">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtzb" runat="server"></asp:TextBox>
                                            </td>
                                            <td class="tableBg2">
                                                天数
                                            </td>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtsfje" runat="server"></asp:TextBox><span style="color: Red">*</span>
                                            </td>
                                            <td colspan="2">
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                <input type="text" id="fykmname" readonly="readonly"  runat="server"
                                        class="baseTextReadOnly"  />
                            ...
                            <tr class="cgspInfo" runat="server" id="cgspInfo" style="display: none">
                                <td colspan="9">
