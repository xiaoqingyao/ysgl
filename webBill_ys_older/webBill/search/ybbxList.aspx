<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ybbxList.aspx.cs" Inherits="webBill_search_ybbxList" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="height: 30px">
                    ...
                    <asp:Button ID="btn_drmx" runat="server" CssClass="baseButton" Text="导出明细" OnClick="btn_drmx_Click" />
                ...
                <td align="left">
                    <table class="baseTable" style="text-align: left;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: right">是否给付：
                            </td>
                            <td>
                    ...
                    <div id="divgrid" style="overflow-x: auto;">
                        <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="deptname" HeaderText="所属部门" ItemStyle-Width="160" HeaderStyle-Width="160"
