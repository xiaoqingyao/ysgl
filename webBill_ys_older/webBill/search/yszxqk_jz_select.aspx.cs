...
public partial class webBill_search_yszxqk_jz_select : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            this.ddlNd.DataBind();
            this.ddlYd.SelectedValue = DateTime.Now.Month.ToString();
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("yszxqk_jz_result.aspx" + strselect);
    }
    ...
    private string getSelectStr()
    {
        ...
        return "?nd=" + this.ddlNd.SelectedValue + "&yd=" + this.ddlYd.SelectedValue + "&deptcode=" + dept;
    }
}