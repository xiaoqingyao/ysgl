...
public partial class webBill_xsreport_fdysdbb : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            if (!IsPostBack)
            {
                this.TextBox1.Text = System.DateTime.Now.Year.ToString() + "-1-1";
    ...
    void bindData()
    {
        ...
        DataSet ds = server.ExecuteProcedure("bill_pro_report_bdysb_xs", sps);
