<%@ Page Language="C#" AutoEventWireup="true" CodeFile="userList_ImportExcel.aspx.cs"
    Inherits="webBill_user_userList_ImportExcel" %>
    ...
    <div class="baseDiv">
        ...
        <table class="myTable" width="100%">
            <tr>
                ...
                <td>
                    <a href="UserImport.xls" class="baseButton" target="_blank" style="display: block; text-align:center;width:40px">导出</a>
                </td>
            </tr>
            <tr>
                <td class="style1">
