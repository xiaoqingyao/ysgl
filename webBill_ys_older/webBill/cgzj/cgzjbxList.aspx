<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cgzjbxList.aspx.cs" Inherits="webBill_cgzj_cgzjbxList" %>
    ...
    <script language="javascript" type="Text/javascript">
        $(function() {
            $("#btn_edit").click(function() {
                ...
                openDetail("cgzjbxDetail.aspx?type=edit&par=" + billcode);
            });
            $("#btn_delete").click(function() {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                $.post("../MyAjax/DeleteBill.ashx", { "billCode": billcode, "type": "cgzjfk" }, function(data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
            ...
            $("#btn_look").click(function() {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                openDetail("cgzjbxDetail.aspx?type=look&par=" + billcode);
            });
            ...
            $("#btn_replace").click(function() {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "cgzjfk" }, function(data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("提交成功！");
            ...
            $("#btn_summit").click(function() {
                ...
                if (zt != "未提交") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "cgzjfk" }, function(data, status) {
                        if (status == "success") {
                            alert("提交成功！");
...
<body>
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td>
                <input type="button" value="增 加" runat="server" id="Button1" class="baseButton" onclick="openDetail('cgzjbxDetail.aspx?type=add&par=' + Math.random());" runat="server"/>
                <input type="button" value="修 改" id="btn_edit" class="baseButton" runat="server"/>
                <span id="spdelete" runat="server"><input type="button" value="删 除" id="btn_delete" class="baseButton" runat="server"/></span>
                <input type="button" value="详细信息" id="btn_look" class="baseButton" />
                    付款日期从：<asp:TextBox ID="txb_sqrqbegin" runat="server" Width="80px"></asp:TextBox>至<asp:TextBox
                ...
                <td>
                    <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="billDept" HeaderText="付款单位">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" CssClass="myGridItem" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="billuser" HeaderText="付款人">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="False" CssClass="myGridItem" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="billdate" HeaderText="付款日期" 
                            ...
                            <asp:BoundColumn DataField="billje" HeaderText="付款总额" DataFormatString="{0:N2}">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
