<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChuZhiDanIndex.aspx.cs" Inherits="webBill_ZiChanGuanLi_ChuZhiDanIndex" %>

<%@ Register Assembly="PaginationControl" Namespace="PaginationControl" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>资产处置列表页</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
    ...
    <script language="javascript" type="text/javascript">
        $(function() {
            ...
            $("#btn_summit").click(function() {
                ...
                if (zt != "未提交") {
                    ...
                    $.post("../../webBill/MyWorkFlow/WorkFlowSummit.ashx", { "billcode": billcode, "flowid": "zcczd", "billtype": "zcczd" }, function(data, status) {
                        if (data == "-1" || data == "-2") {
                            alert("提交失败！");
                        } else if (data == "-3") {
            ...
            $("#btn_replace").click(function() {
                ...
                if (zt == "未提交" || zt == "审批通过") {
                    ...
                    var billcode = checkrow.find("td")[0].innerHTML;
                    $.post("../../webBill/MyWorkFlow/WorkFlowReplace.ashx", { "billcode": billcode, "flowid": "zcczd", "billtype": "zcczd" }, function(data, status) {
                        if (status == "success") {
                            if (data == "1") {
                                alert("撤销成功！");
            ...
            $("#btn_Delete").click(function() {
                ...
                var zt = row.find("td")[4].innerHTML;
                if (zt != "未提交") {
                    alert("该行已提交,不能删除！");
                    return;
                }
                if (!confirm("你确定要删除编号为" + id + "的单据吗？")) { return; }
                $.post("../MyAjax/DeleteBill.ashx", { "billCode": id, "type": "zcczd" }, function(data, status) {
                    if (status == "success") {
                        if (data == "1") {
                            alert("删除成功!");
                            $(".highlight").remove();
        ...
        function Edit() {
            ...
            if (checkrow.val() == undefined) {
                ...
                if (lx == "未提交") {
                    ...
                    openDetail('ChuZhiDanDetail.aspx?type=Edit&&bh=' + bh);
                } else {
                alert("该行已经提交，不允许修改！");
                    return false;
                }
        ...
        function Look() {
            ...
            if (checkrow.val() == undefined) {
                ...
                var bh = checkrow.find("td")[0].innerHTML;
                openDetail('ChuZhiDanDetail.aspx?type=look&&bh=' + bh);
            }
        }
            ...
            <tr>
                <td>
                    <div class="baseDiv" style="margin-bottom: 3px; margin-top: 3px">
                        ...
                        <input type="button" value="增 加" runat="server" id="Button1" class="baseButton" onclick="openDetail('ChuZhiDanDetail.aspx?type=Add')" />
