<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZiChanZengJianFangShi.aspx.cs"
    Inherits="ZiChan_ZiChanGuanLi_ZiChanZengJianFangShi" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>增减方式列表</title> <meta http-equiv="X-UA-Compatible" content="IE=8" >
        ...
        $(function() {
            ...
            //修改
             $("#btn_edit").click(function() {
                ...
                openDetail("zjfsDetail.aspx?Ctrl=Edit&Code="+ billcode);
            });
            //删除
          ...
          $("#btn_look").click(function() {
                ...
                var billcode = checkrow.find("td")[0].innerHTML;
                openDetail("zjfsDetail.aspx?Ctrl=look&Code=" + billcode);
            });
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td style="height: 27px">
                ...
                <input type="button" value="增 加" runat="server" id="Button1" class="baseButton" onclick="openDetail('zjfsDetail.aspx?Ctrl=Add&par=' + Math.random());" />
            ...
            <td>
                ...
                <div id="main" style="overflow-y: scroll; margin-top: -1px; width: 1100px; height: 390px;">
                    <asp:DataGrid ID="myGrid" runat="server" BorderWidth="1px" CellPadding="3" CssClass="myGrid"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="FangshiCode" HeaderText="编号">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                            ...
                            <asp:BoundColumn DataField="Fangshiname" HeaderText="增减方式名称">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Left" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" Wrap="true" CssClass="myGridItem" HorizontalAlign="Left" />
                            </asp:BoundColumn>
                            <asp:BoundColumn DataField="zjfs" HeaderText="增减方式">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="False" CssClass="myGridHeader" />
                                <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
