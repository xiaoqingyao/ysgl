<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZiChanLeiBieList.aspx.cs" Inherits="ZiChan_ZiChanGuanLi_ZiChanLeiBieList" %>
        ...
        $(function() {
           ...
           $("#<%=tlm.ClientID%> tr").filter(":not(:has(table, th))").click(function() {
            ...
            $("#btn_add").click(function() {
                ...
                {
                     openDetail("ZiChanLeiBieDetail.aspx?Ctrl=Add");
                }
               else{
                    var code = checkRow.find('td')[2].innerHTML;
                    openDetail("ZiChanLeiBieDetail.aspx?Ctrl=Add&Code=" + code);
                } 
            });
            //删除
            ...
            $("#btn_update").click(function() {
             var checkrow = $(".highlight");
                ...
                var code = checkrow.find('td')[2].innerHTML;
                openDetail("ZiChanLeiBieDetail.aspx?Ctrl=Edit&Code=" + code);
            });
            ...
            <tr>
                <td>
                    <asp:TreeListView runat="server" ID="tlm" NodeColumnIndex="1" ParentKey="ParentCode"
                        ColumnKey="LeibieCode" CssClass="myGrid" Width="100%" AutoGenerateColumns="false" runat="server"  
                        ExpendDepth="5">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LeibieName" HeaderText="类型名称" />
                            <asp:BoundField DataField="LeibieCode" HeaderText="类型编码" />
                            <asp:BoundField DataField="ParentCode" HeaderText="上级编号" />
                            <asp:BoundField DataField="ShiYongQiXian" HeaderText="使用期限（月）" ItemStyle-Width="200"
                                HeaderStyle-Width="200" />
                            <asp:BoundField DataField="JiLiangDanWei" HeaderText="计量单位" ItemStyle-Width="200"
                                HeaderStyle-Width="200" />
