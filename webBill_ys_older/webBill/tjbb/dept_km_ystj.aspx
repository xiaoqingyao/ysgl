<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dept_km_ystj.aspx.cs" Inherits="webBill_tjbb_dept_km_ystj" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        $(function() {
            ...
            gudingbiaotounew($("#GridView1"), $(window).height() - 160);
        ...
        function print() {
            var nd = $("#ddlNd").val();
            window.location.href = 'dept_km_ystj_dy.aspx?nd=' + nd;
        }
    </script>
        ...
        <tr>
            <td>
                <div>
                    ...
                    年度：<asp:DropDownList ID="ddlNd" runat="server">
                    </asp:DropDownList>
                    ...
                    <input type="button" class="baseButton" value="打印预览" id="btn_print" onclick="print();" />
                    <input type="button" class="baseButton" value="帮助" onclick="javascript:parent.helptoggle();" />
                    <label style="color: Red">
                        报表说明：各部门对应的预算数为该部门的年度预算数。</label>
                </div>
            </td>
        </tr>
        <tr>
            <td>
                <div style="position: relative; word-warp: break-word; word-break: break-all">
                    <asp:GridView ID="GridView1" runat="server" CssClass="myGrid" AutoGenerateColumns="False"
                        OnPreRender="GridView1_PreRender" ShowFooter="True" OnRowDataBound="GridView1_RowDataBound">
