<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stepLook.aspx.cs" Inherits="WorkFlow_stepLook" %>
            ...
            <tr>
                <td>
                    <asp:DataGrid ID="myGrid" runat="server" AutoGenerateColumns="False" CellPadding="3" CssClass="myGrid" >
                        <Columns>
                            <%--<asp:BoundColumn DataField="beginStep" HeaderText="起始步骤">
                            ...
                            <asp:BoundColumn DataField="endStep" HeaderText="截至步骤">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                            ...
                            <asp:BoundColumn DataField="checkDate" HeaderText="审核时间">
                                <HeaderStyle CssClass="myGridHeader" Font-Bold="True" Font-Italic="False" Font-Overline="False"
                                    Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" Wrap="False" />
                                <ItemStyle CssClass="myGridItem" Font-Bold="False" Font-Italic="False" Font-Overline="False"
                            ...
                            <asp:BoundColumn DataField="result" HeaderText="审核结论">
