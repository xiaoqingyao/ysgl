...
function editStep(stepId,stepType){
	workFlowStepDialog(stepId,stepType);
}
...
function delStep(stepId){
    ...
    deleteDataBaseStegpGroup(stepId);
...
function flowContextMenu(){
  //菜单源文本
  var menuSrc = '<menu><entity id="c0"><description>添加节点</description><image>inc/contextMenu/images/add_step.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();newStep("NormalStep");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c1"><description>添加动作</description><image>inc/contextMenu/images/add_action.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();newAction();</onClick><contents></contents></entity>';
...
function stepContextMenu(stepId,stepType){
  //菜单源文本
  var menuSrc = '<menu><entity id="c0"><description>编辑节点['+stepId+']</description><image>inc/contextMenu/images/edit_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();editStep("'+stepId+'","'+stepType+'");</onClick><contents></contents></entity>';
  if(stepType!='BeginStep' && stepType!='EndStep') menuSrc+= '<entity id="c1"><description>删除节点['+stepId+']</description><image>inc/contextMenu/images/del_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();delStep("'+stepId+'");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c2"><description>刷新</description><image>inc/contextMenu/images/refresh_vml.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();redrawVML();</onClick><contents></contents></entity></menu>';
  showContextMenu(menuSrc);
}
...
function actionContextMenu(actionId){
  //菜单源文本
  var menuSrc = '<menu><entity id="c0"><description>编辑动作['+actionId+']</description><image>inc/contextMenu/images/edit_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();editAction("'+actionId+'");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c1"><description>删除动作['+actionId+']</description><image>inc/contextMenu/images/del_obj.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();delAction("'+actionId+'");</onClick><contents></contents></entity>';
  menuSrc+= '<entity id="c2"><description>刷新</description><image>inc/contextMenu/images/refresh_vml.gif</image><fontcolor>'+MenuTextColor_enable+'</fontcolor><onClick>cleancontextMenu();redrawVML();</onClick><contents></contents></entity></menu>';
  showContextMenu(menuSrc);
}
...
function workFlowDialog(id,type){
    ...
    switch (type) {
        case 'NormalStep': dialogURL = id==null?'_stepdialog.html':'_stepdialog.html?flowid='+flowID+'&stepid='+id;break;
        case 'BeginStep': dialogURL = id == null ? '_stepdialog.html' : '_stepdialog.html?flowid=' + flowID + '&stepid=' + id; break;
        case 'EndStep': dialogURL = id == null ? '_stepdialog.html' : '_stepdialog.html?flowid=' + flowID + '&stepid=' + id; break;
        case 'Action': dialogURL = id == null ? '_actiondialog.html' : '_actiondialog.html?flowid=' + flowID + '&actionid=' + id; break;
        case 'Flow': dialogURL = id == null ? '_flowdialog.html' : '_flowdialog.html?flowid=' + flowID; break;		
	} 
...
function workFlowStepDialog(id,type){

    var local = document.location.href;
    var flowID = local.split("=")[1];

    switch (type) {
        case 'NormalStep': dialogURL = id==null?'_stepdialog.html':'_stepdialogEdit.html?flowid='+flowID+'&stepid='+id;break;
        case 'BeginStep': dialogURL = id == null ? '_stepdialog.html' : '_stepdialogEdit.html?flowid=' + flowID + '&stepid=' + id; break;
        case 'EndStep': dialogURL = id == null ? '_stepdialog.html' : '_stepdialogEdit.html?flowid=' + flowID + '&stepid=' + id; break;
        case 'Action': dialogURL = id == null ? '_actiondialog.html' : '_actiondialog.html?flowid=' + flowID + '&actionid=' + id; break;
        case 'Flow': dialogURL = id == null ? '_flowdialog.html' : '_flowdialog.html?flowid=' + flowID; break;		
	} 
	var dialog = window.showModalDialog(dialogURL, window, "dialogWidth:373px; dialogHeight:460px; center:yes; help:no; resizable:no; status:no") ;
